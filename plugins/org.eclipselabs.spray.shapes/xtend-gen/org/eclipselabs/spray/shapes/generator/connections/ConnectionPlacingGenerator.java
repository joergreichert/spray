...
public class ConnectionPlacingGenerator {
  ...
  protected CharSequence _createElement(final CDRectangle element, final String parentName, final String shapeStyle, final Integer angle, final Integer distance) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("List<Point> pL = new ArrayList<Point>();");
      _builder.newLine();
      _builder.newLine();
      _builder.append("Point p1 = gaService.createPoint(");
      ...
      _builder.append(", 0, 0);");
      _builder.newLineIfNotEmpty();
      _builder.append("pL.add(p1);");
      _builder.newLine();
      _builder.append("Point p2 = gaService.createPoint(");
      ...
      _builder.append(", 0, 0);");
      _builder.newLineIfNotEmpty();
      _builder.append("pL.add(p2);");
      _builder.newLine();
      _builder.append("Point p3 = gaService.createPoint(");
      ...
      _builder.append(", 0, 0);");
      _builder.newLineIfNotEmpty();
      _builder.append("pL.add(p3);");
      _builder.newLine();
      _builder.append("Point p4 = gaService.createPoint(");
      ...
      _builder.append(", 0, 0);");
      _builder.newLineIfNotEmpty();
      _builder.append("pL.add(p4);");
      _builder.newLine();
      _builder.newLine();
      _builder.append("//Create Rectangle with Polygon");
      _builder.newLine();
