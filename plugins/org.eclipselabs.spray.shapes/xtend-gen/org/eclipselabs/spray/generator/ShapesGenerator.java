...
import org.eclipselabs.spray.generator.ShapesLayoutGenerator;
...
public class ShapesGenerator implements IGenerator {
  @Inject
  private ShapesLayoutGenerator layoutGen;
  
  public void doGenerate(final Resource resource, final IFileSystemAccess fsa) {
    Iterable<EObject> _allContentsIterable = ResourceExtensions.allContentsIterable(resource);
    Iterable<ShapeDefinition> _filter = IterableExtensions.<ShapeDefinition>filter(_allContentsIterable, org.eclipselabs.spray.shapes.ShapeDefinition.class);
