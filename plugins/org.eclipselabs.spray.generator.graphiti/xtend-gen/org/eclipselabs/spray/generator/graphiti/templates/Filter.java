...
public class Filter extends FileGenerator {
  ...
  public CharSequence generateBaseFile(final EObject modelElement) {
    ...
    CharSequence _mainFile = this.mainFile(((EClass) modelElement), _baseClassName);
    return _mainFile;
  }
  ...
  public CharSequence generateExtensionFile(final EObject modelElement) {
    ...
    CharSequence _mainExtensionPointFile = this.mainExtensionPointFile(((EClass) modelElement), _className);
