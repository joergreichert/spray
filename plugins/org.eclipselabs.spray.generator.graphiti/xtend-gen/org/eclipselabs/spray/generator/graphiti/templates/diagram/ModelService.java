...
public class ModelService extends FileGenerator {
  ...
  public StringConcatenation mainFile(final Diagram diagram, final String className) {
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (peService.getProperty(dtp.getDiagram(), ISprayConstants.PROPERTY_URI)==null) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("return createModel();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("URI uri = URI.createURI(peService.getProperty(diagram, ISprayConstants.PROPERTY_URI).getValue());");
    _builder.newLine();
    _builder.append("        ");
    _builder.append(modelClassName, "        ");
    _builder.append(" model = (");
    _builder.append(modelClassName, "        ");
    _builder.append(") diagram.eResource().getResourceSet().getEObject(uri, true);");
    _builder.newLineIfNotEmpty();
    _builder.append("        ");
