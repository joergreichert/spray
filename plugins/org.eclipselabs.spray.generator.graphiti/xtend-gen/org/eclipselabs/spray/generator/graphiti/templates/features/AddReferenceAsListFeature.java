...
public class AddReferenceAsListFeature extends FileGenerator {
  ...
  public StringConcatenation mainFile(final MetaReference reference, final String className) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("import org.eclipselabs.spray.runtime.graphiti.features.AbstractEMFAddShapeFeature;");
    _builder.newLine();
    ...
    _builder.append("public class ");
    _builder.append(className, "");
    _builder.append(" extends AbstractEMFAddShapeFeature {");
    _builder.newLineIfNotEmpty();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("String modelType = Graphiti.getPeService().getPropertyValue(shape, PROPERTY_MODEL_TYPE);");
    _builder.newLine();
    _builder.append("            ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("Graphiti.getPeService().setPropertyValue(newShape, PROPERTY_STATIC, \"true\");");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("Graphiti.getPeService().setPropertyValue(newShape, PROPERTY_MODEL_TYPE, \"");
