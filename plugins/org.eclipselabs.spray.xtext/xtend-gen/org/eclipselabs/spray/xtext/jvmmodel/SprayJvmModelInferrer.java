...
public class SprayJvmModelInferrer extends AbstractModelInferrer {
  ...
  protected void _infer(final MetaClass clazz, final IAcceptor<JvmDeclaredType> acceptor, final boolean prelinkingPhase) {
      ...
      boolean _operator_equals_1 = ObjectExtensions.operator_equals(eClassJvmType, null);
      if (_operator_equals_1) {
        _operator_or_1 = true;
      } else {
        boolean _eIsProxy_1 = eClassJvmType.eIsProxy();
        _operator_or_1 = BooleanExtensions.operator_or(_operator_equals_1, _eIsProxy_1);
      }
      if (_operator_or_1) {
        return;
      }
      ...
      boolean _operator_equals_2 = ObjectExtensions.operator_equals(_alias, null);
