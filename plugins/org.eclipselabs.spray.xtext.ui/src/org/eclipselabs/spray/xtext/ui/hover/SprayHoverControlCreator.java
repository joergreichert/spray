...
public class SprayHoverControlCreator extends AbstractReusableInformationControlCreator {
    private final SprayEObjectHoverProvider  sprayEObjectHoverProvider;
    private Map<Shell, IInformationControl>  fInformationControls = new HashMap<Shell, IInformationControl>();
    private final IInformationControlCreator fInformationPresenterControlCreator;

    public SprayHoverControlCreator(SprayEObjectHoverProvider sprayEObjectHoverProvider, IInformationControlCreator informationPresenterControlCreator) {
        this.sprayEObjectHoverProvider = sprayEObjectHoverProvider;
    ...
    public IInformationControl doCreateInformationControl(Shell parent) {
        ...
        if (BrowserInformationControl.isAvailable(parent)) {
            ...
            sprayEObjectHoverProvider.addLinkListener(iControl);
            return iControl;
        } else {
