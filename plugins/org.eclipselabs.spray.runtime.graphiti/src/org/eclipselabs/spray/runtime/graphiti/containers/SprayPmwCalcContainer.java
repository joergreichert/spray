...
public class SprayPmwCalcContainer implements ISprayContainer {
    ...
    public boolean layoutContainer(ILayoutContext context) {
        ...
        for (Shape shape : containerShape.getChildren()) {
            ...
            if (shapeType.equalsIgnoreCase(DOWN)) {
                ...
                Point newFirstPoint = gaService.createPoint(leftMargin, height - downRibbonHeight - 1);
                Point newSecondPoint = gaService.createPoint(width - (leftMargin), height - downRibbonHeight - 1);
