...
public class SprayResizeLayoutManager implements ISprayConstants {
    ...
    public void resizeElementsRecursive(ContainerShape shape, double widthFactor, double heightFactor) {
        ...
        if (shape.getChildren().size() == 0) {
            ...
            for (Shape child : shape.getChildren()) {
                ...
                //                    
                //                    SprayLayoutService.isFlexible(child) ;
                //                    System.out.println("resizeRecursive: child NOT FLEXIBLE" + SprayLayoutService.getId(child));
                //                    return;
                //                }
    ...
    public void resizePolyline(Polyline p, IDimension size, double widthFactor, double heightFactor) {
        System.out.println("========================== resize line " + widthFactor + " , " + heightFactor);
