 ...
 * @generated
 */
public class DateTimePropertyImpl extends PropertyImpl implements IDateTimeProperty {
    /**
    ...
    protected EClass eStaticClass() {
        return IBusinessDomainDslPackage.Literals.DATE_TIME_PROPERTY;
    }
    ...
    public void setAccuracy(DateTimeAccuracy newAccuracy) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.DATE_TIME_PROPERTY__ACCURACY, oldAccuracy, accuracy));
    }
    ...
    public void setDefaultValue(String newDefaultValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.DATE_TIME_PROPERTY__DEFAULT_VALUE, oldDefaultValue, defaultValue));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case IBusinessDomainDslPackage.DATE_TIME_PROPERTY__ACCURACY:
                return getAccuracy();
            case IBusinessDomainDslPackage.DATE_TIME_PROPERTY__DEFAULT_VALUE:
