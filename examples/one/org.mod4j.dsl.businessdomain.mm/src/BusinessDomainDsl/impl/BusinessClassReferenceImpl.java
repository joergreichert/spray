 ...
 * @generated
 */
public class BusinessClassReferenceImpl extends AbstractBusinessClassImpl implements IBusinessClassReference {
    /**
    ...
    protected EClass eStaticClass() {
        return IBusinessDomainDslPackage.Literals.BUSINESS_CLASS_REFERENCE;
    }
    ...
    public void setReferredModel(String newReferredModel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.BUSINESS_CLASS_REFERENCE__REFERRED_MODEL, oldReferredModel, referredModel));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case IBusinessDomainDslPackage.BUSINESS_CLASS_REFERENCE__REFERRED_MODEL:
