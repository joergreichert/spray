 ...
 * @generated
 */
public class StringPropertyImpl extends PropertyImpl implements IStringProperty {
    /**
    ...
    protected EClass eStaticClass() {
        return IBusinessDomainDslPackage.Literals.STRING_PROPERTY;
    }
    ...
    public void setRegularExpression(String newRegularExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.STRING_PROPERTY__REGULAR_EXPRESSION, oldRegularExpression, regularExpression));
    }
    ...
    public void setMinLength(int newMinLength) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.STRING_PROPERTY__MIN_LENGTH, oldMinLength, minLength));
    }
    ...
    public void setMaxLength(int newMaxLength) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.STRING_PROPERTY__MAX_LENGTH, oldMaxLength, maxLength));
    }
    ...
    public void setDefaultValue(String newDefaultValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.STRING_PROPERTY__DEFAULT_VALUE, oldDefaultValue, defaultValue));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case IBusinessDomainDslPackage.STRING_PROPERTY__REGULAR_EXPRESSION:
                return getRegularExpression();
            case IBusinessDomainDslPackage.STRING_PROPERTY__MIN_LENGTH:
                return getMinLength();
            case IBusinessDomainDslPackage.STRING_PROPERTY__MAX_LENGTH:
                return getMaxLength();
            case IBusinessDomainDslPackage.STRING_PROPERTY__DEFAULT_VALUE:
