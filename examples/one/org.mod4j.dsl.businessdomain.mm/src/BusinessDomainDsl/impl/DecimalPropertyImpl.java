 ...
 * @generated
 */
public class DecimalPropertyImpl extends PropertyImpl implements IDecimalProperty {
    /**
    ...
    protected EClass eStaticClass() {
        return IBusinessDomainDslPackage.Literals.DECIMAL_PROPERTY;
    }
    ...
    public void setMinValue(float newMinValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.DECIMAL_PROPERTY__MIN_VALUE, oldMinValue, minValue));
    }
    ...
    public void setMaxValue(float newMaxValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.DECIMAL_PROPERTY__MAX_VALUE, oldMaxValue, maxValue));
    }
    ...
    public void setMinInclusive(boolean newMinInclusive) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.DECIMAL_PROPERTY__MIN_INCLUSIVE, oldMinInclusive, minInclusive));
    }
    ...
    public void setMaxInclusive(boolean newMaxInclusive) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.DECIMAL_PROPERTY__MAX_INCLUSIVE, oldMaxInclusive, maxInclusive));
    }
    ...
    public void setDefaultValue(float newDefaultValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IBusinessDomainDslPackage.DECIMAL_PROPERTY__DEFAULT_VALUE, oldDefaultValue, defaultValue));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case IBusinessDomainDslPackage.DECIMAL_PROPERTY__MIN_VALUE:
                return getMinValue();
            case IBusinessDomainDslPackage.DECIMAL_PROPERTY__MAX_VALUE:
                return getMaxValue();
            case IBusinessDomainDslPackage.DECIMAL_PROPERTY__MIN_INCLUSIVE:
                return isMinInclusive();
            case IBusinessDomainDslPackage.DECIMAL_PROPERTY__MAX_INCLUSIVE:
                return isMaxInclusive();
            case IBusinessDomainDslPackage.DECIMAL_PROPERTY__DEFAULT_VALUE:
