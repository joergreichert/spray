 ...
 * <ul>
 *   <li>{@link Forms.impl.FormImpl#getSections <em>Sections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FormImpl extends EObjectImpl implements Form {
	...
	public EList<Section> getSections() {
		if (sections == null) {
			sections = new EObjectContainmentEList<Section>(Section.class, this, FormsPackage.FORM__SECTIONS);
		}
		return sections;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FormsPackage.FORM__SECTIONS:
