...
public class StatemachineUpdateStartZustandFeatureBase extends AbstractUpdateFeature {
    public StatemachineUpdateStartZustandFeatureBase(IFeatureProvider fp) {
        super(fp);
    ...
    public boolean canUpdate(IUpdateContext context) {
        ...
        return (bo instanceof StartState)&& (!(pictogramElement instanceof Diagram));
    }
    /**
     * {@inheritDoc}
     */
    ...
    public boolean update(IUpdateContext context) {
        PictogramElement pictogramElement = context.getPictogramElement();
        EObject bo = getBusinessObjectForPictogramElement(pictogramElement);
          StartState eClass = (StartState) bo;
        return true; // SprayContainerService.update(pictogramElement, getValues(eClass));
        
    }
    Map<String, String> values = null; 
    protected Map<String, String> getValues(StartState eClass) {
        if (values == null) {
    ...
    protected void fillValues(StartState eClass) {
        String type, value;
    }
    
    protected String getValue (String type, StartState eClass) {
        return "UNKNOWN";
    }
}
