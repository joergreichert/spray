...
public class NormalStateNameSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
 
    protected State bc = null;
...
public void refresh() {
    ...
    if (pe != null) {
       ...
       // the filter assured, that it is a State
        if (bo == null)
            return;
        bc = (State)bo;
        String value = "";
