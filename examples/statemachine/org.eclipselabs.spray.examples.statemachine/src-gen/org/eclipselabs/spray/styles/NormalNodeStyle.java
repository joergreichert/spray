...
public class NormalNodeStyle extends DefaultSprayStyle {
	...
	public Style newStyle(Diagram diagram) {
		...
		style.setId("NormalNodeStyle");
		style.setDescription("styles a normal state node");
		
		// transparency value
		
		// background attributes
		style.setFilled(true);
		style.setBackground(gaService.manageColor(diagram, new ColorConstant(0, 64, 128)));
