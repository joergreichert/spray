 ...
 * @generated
 */
public class ContainSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ContainPackage modelPackage;
	 ...
	 * @generated
	 */
	public ContainSwitch() {
		if (modelPackage == null) {
			modelPackage = ContainPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContainPackage.E: {
				E e = (E)theEObject;
				T result = caseE(e);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainPackage.E1: {
				E1 e1 = (E1)theEObject;
				T result = caseE1(e1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainPackage.E2: {
				E2 e2 = (E2)theEObject;
				T result = caseE2(e2);
				if (result == null) result = caseE(e2);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainPackage.E3: {
				E3 e3 = (E3)theEObject;
				T result = caseE3(e3);
				if (result == null) result = caseE(e3);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
