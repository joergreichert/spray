 ...
 * @generated
 */
public class JoePackageImpl extends EPackageImpl implements JoePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see joe.JoePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private JoePackageImpl() {
		super(eNS_URI, JoeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link JoePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static JoePackage init() {
		if (isInited) return (JoePackage)EPackage.Registry.INSTANCE.getEPackage(JoePackage.eNS_URI);

		// Obtain or create and register package
		JoePackageImpl theJoePackage = (JoePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof JoePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new JoePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theJoePackage.createPackageContents();

		// Initialize created meta-data
		theJoePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theJoePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(JoePackage.eNS_URI, theJoePackage);
		return theJoePackage;
	}
	 ...
	 * @generated
	 */
	public EReference getGoalModel_Strategies() {
	 ...
	 * @generated
	 */
	public JoeFactory getJoeFactory() {
		return (JoeFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(goalModelEClass, GOAL_MODEL__STRATEGIES);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getGoal_Strategies(), this.getStrategy(), null, "strategies", null, 1, -1, Goal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGoalModel_Strategies(), this.getStrategy(), null, "strategies", null, 0, -1, GoalModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
