 ...
 * <ul>
 *   <li>{@link ConceptMapDSL.impl.DefaultConnectionImpl#getFromElement <em>From Element</em>}</li>
 *   <li>{@link ConceptMapDSL.impl.DefaultConnectionImpl#getToElement <em>To Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DefaultConnectionImpl extends MapElementsImpl implements DefaultConnection {
	/**
	...
	protected EClass eStaticClass() {
		return ConceptMapDSLPackage.Literals.DEFAULT_CONNECTION;
	}
		...
		if (fromElement != null && fromElement.eIsProxy()) {
			...
			if (fromElement != oldFromElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptMapDSLPackage.DEFAULT_CONNECTION__FROM_ELEMENT, oldFromElement, fromElement));
			}
		}
		return fromElement;
	}
	...
	public void setFromElement(Element newFromElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptMapDSLPackage.DEFAULT_CONNECTION__FROM_ELEMENT, oldFromElement, fromElement));
	}
	...
	public Element getToElement() {
		if (toElement != null && toElement.eIsProxy()) {
			...
			if (toElement != oldToElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptMapDSLPackage.DEFAULT_CONNECTION__TO_ELEMENT, oldToElement, toElement));
			}
		}
		return toElement;
	}
	...
	public void setToElement(Element newToElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptMapDSLPackage.DEFAULT_CONNECTION__TO_ELEMENT, oldToElement, toElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptMapDSLPackage.DEFAULT_CONNECTION__FROM_ELEMENT:
				if (resolve) return getFromElement();
				return basicGetFromElement();
			case ConceptMapDSLPackage.DEFAULT_CONNECTION__TO_ELEMENT:
