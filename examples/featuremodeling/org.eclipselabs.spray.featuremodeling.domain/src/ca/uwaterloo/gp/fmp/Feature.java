 ...
 * <ul>
 *   <li>{@link ca.uwaterloo.gp.fmp.Feature#getName <em>Name</em>}</li>
 *   <li>{@link ca.uwaterloo.gp.fmp.Feature#getValueType <em>Value Type</em>}</li>
 *   <li>{@link ca.uwaterloo.gp.fmp.Feature#getConfigurations <em>Configurations</em>}</li>
 *   <li>{@link ca.uwaterloo.gp.fmp.Feature#getReferences <em>References</em>}</li>
 *   <li>{@link ca.uwaterloo.gp.fmp.Feature#getTypedValue <em>Typed Value</em>}</li>
 *   <li>{@link ca.uwaterloo.gp.fmp.Feature#getDescribedNode <em>Described Node</em>}</li>
 *   <li>{@link ca.uwaterloo.gp.fmp.Feature#getConstraints <em>Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature()
 * @model
 * @generated
 */
public interface Feature extends Clonable {
	 ...
	 * @see #setName(String)
	 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature_Name()
	 * @model
	 * @generated
	 */
	String getName();
	 ...
	 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature_ValueType()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link ca.uwaterloo.gp.fmp.Feature}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature_Configurations()
	 * @model type="ca.uwaterloo.gp.fmp.Feature" containment="true"
	 * @generated
	 */
	 ...
	 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature_References()
	 ...
	 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature_TypedValue()
	 ...
	 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature_DescribedNode()
	 ...
	 * @see ca.uwaterloo.gp.fmp.FmpPackage#getFeature_Constraints()
