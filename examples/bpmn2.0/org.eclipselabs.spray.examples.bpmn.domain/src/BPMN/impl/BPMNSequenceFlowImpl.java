 ...
 * <ul>
 *   <li>{@link BPMN.impl.BPMNSequenceFlowImpl#getFormElement <em>Form Element</em>}</li>
 *   <li>{@link BPMN.impl.BPMNSequenceFlowImpl#getToElement <em>To Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BPMNSequenceFlowImpl extends BPMNModelElementImpl implements BPMNSequenceFlow {
	/**
	 ...
	 * @generated
	 */
	protected BPMNSequenceFlowImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BPMNPackage.Literals.BPMN_SEQUENCE_FLOW;
	}
		...
		if (formElement != null && formElement.eIsProxy()) {
			...
			if (formElement != oldFormElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMNPackage.BPMN_SEQUENCE_FLOW__FORM_ELEMENT, oldFormElement, formElement));
			}
		}
		return formElement;
	}
	...
	public void setFormElement(BPMNModelElement newFormElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.BPMN_SEQUENCE_FLOW__FORM_ELEMENT, oldFormElement, formElement));
	}
	...
	public BPMNModelElement getToElement() {
		if (toElement != null && toElement.eIsProxy()) {
			...
			if (toElement != oldToElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMNPackage.BPMN_SEQUENCE_FLOW__TO_ELEMENT, oldToElement, toElement));
			}
		}
		return toElement;
	}
	...
	public void setToElement(BPMNModelElement newToElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.BPMN_SEQUENCE_FLOW__TO_ELEMENT, oldToElement, toElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.BPMN_SEQUENCE_FLOW__FORM_ELEMENT:
				if (resolve) return getFormElement();
				return basicGetFormElement();
			case BPMNPackage.BPMN_SEQUENCE_FLOW__TO_ELEMENT:
