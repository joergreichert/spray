...
(
    ...
    { 
        $current = $this_NodeElement_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleEdgeElement returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getEdgeElementRule()); }
	 iv_ruleEdgeElement=ruleEdgeElement 
	 { $current=$iv_ruleEdgeElement.current; } 
	 EOF 
;

// Rule EdgeElement
ruleEdgeElement returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='edge' 
...
entryRuleNodeFigureSection returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNodeFigureSectionRule()); }
	 iv_ruleNodeFigureSection=ruleNodeFigureSection 
	 { $current=$iv_ruleNodeFigureSection.current; } 
	 EOF 
;

// Rule NodeFigureSection
ruleNodeFigureSection returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='figure' 
...
entryRuleEdgeFigureSection returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getEdgeFigureSectionRule()); }
	 iv_ruleEdgeFigureSection=ruleEdgeFigureSection 
	 { $current=$iv_ruleEdgeFigureSection.current; } 
	 EOF 
;

// Rule EdgeFigureSection
ruleEdgeFigureSection returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='figure' 
...
entryRuleToolingSection returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getToolingSectionRule()); } 
	 iv_ruleToolingSection=ruleToolingSection 
	 { $current=$iv_ruleToolingSection.current.getText(); }  
	 EOF 
;

// Rule ToolingSection
ruleToolingSection returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
...
entryRuleBehaviorSection returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getBehaviorSectionRule()); } 
	 iv_ruleBehaviorSection=ruleBehaviorSection 
	 { $current=$iv_ruleBehaviorSection.current.getText(); }  
	 EOF 
;

// Rule BehaviorSection
ruleBehaviorSection returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
...
entryRuleTextPropertyAssignment returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTextPropertyAssignmentRule()); }
	 iv_ruleTextPropertyAssignment=ruleTextPropertyAssignment 
	 { $current=$iv_ruleTextPropertyAssignment.current; } 
	 EOF 
;

// Rule TextPropertyAssignment
ruleTextPropertyAssignment returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='text' 
...
entryRuleCompartmentPropertyAssignment returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCompartmentPropertyAssignmentRule()); }
	 ...
	 { $current=$iv_ruleCompartmentPropertyAssignment.current; } 
	 EOF 
;

// Rule CompartmentPropertyAssignment
ruleCompartmentPropertyAssignment returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
