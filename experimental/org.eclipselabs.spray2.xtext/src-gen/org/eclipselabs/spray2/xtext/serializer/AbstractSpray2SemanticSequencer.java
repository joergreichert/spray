package org.eclipselabs.spray2.xtext.serializer;
...
public class AbstractSpray2SemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected Spray2GrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == Spray2Package.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case Spray2Package.COMPARTMENT_PROPERTY_ASSIGNMENT:
				if(context == grammarAccess.getCompartmentPropertyAssignmentRule()) {
					sequence_CompartmentPropertyAssignment(context, (CompartmentPropertyAssignment) semanticObject); 
					return; 
				}
				else break;
			...
			case Spray2Package.EDGE_ELEMENT:
				if(context == grammarAccess.getEdgeElementRule() ||
				   context == grammarAccess.getSprayElementRule()) {
					sequence_EdgeElement(context, (EdgeElement) semanticObject); 
					return; 
				}
				else break;
			case Spray2Package.EDGE_FIGURE_SECTION:
				if(context == grammarAccess.getEdgeFigureSectionRule()) {
					sequence_EdgeFigureSection(context, (EdgeFigureSection) semanticObject); 
					return; 
				}
				else break;
			...
			case Spray2Package.NODE_ELEMENT:
				if(context == grammarAccess.getNodeElementRule() ||
				   context == grammarAccess.getSprayElementRule()) {
					sequence_NodeElement(context, (NodeElement) semanticObject); 
					return; 
				}
				else break;
			case Spray2Package.NODE_FIGURE_SECTION:
				if(context == grammarAccess.getNodeFigureSectionRule()) {
					sequence_NodeFigureSection(context, (NodeFigureSection) semanticObject); 
					return; 
				}
				else break;
			...
			case Spray2Package.TEXT_PROPERTY_ASSIGNMENT:
				if(context == grammarAccess.getTextPropertyAssignmentRule()) {
					sequence_TextPropertyAssignment(context, (TextPropertyAssignment) semanticObject); 
					return; 
				}
				else break;
			}
	...
	/**
	 * Constraint:
	 *     (key=[JvmEnumerationLiteral|QualifiedName] attribute=[EAttribute|ID])
	 */
	protected void sequence_CompartmentPropertyAssignment(EObject context, CompartmentPropertyAssignment semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, Spray2Package.Literals.COMPARTMENT_PROPERTY_ASSIGNMENT__KEY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Spray2Package.Literals.COMPARTMENT_PROPERTY_ASSIGNMENT__KEY));
			if(transientValues.isValueTransient(semanticObject, Spray2Package.Literals.COMPARTMENT_PROPERTY_ASSIGNMENT__ATTRIBUTE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Spray2Package.Literals.COMPARTMENT_PROPERTY_ASSIGNMENT__ATTRIBUTE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getCompartmentPropertyAssignmentAccess().getKeyJvmEnumerationLiteralQualifiedNameParserRuleCall_1_0_1(), semanticObject.getKey());
		feeder.accept(grammarAccess.getCompartmentPropertyAssignmentAccess().getAttributeEAttributeIDTerminalRuleCall_3_0_1(), semanticObject.getAttribute());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (imports+=Import* name=ID modelType=[EClass|QualifiedName] style=SprayStyleRef? sprayElements+=SprayElement*)
	 */
	 ...
	 *     )
	 */
	protected void sequence_EdgeElement(EObject context, EdgeElement semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (shapeRef=JvmTypeReference textProperties+=TextPropertyAssignment*)
	 */
	protected void sequence_EdgeFigureSection(EObject context, EdgeFigureSection semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, Spray2Package.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Spray2Package.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	 ...
	 *     )
	 */
	protected void sequence_NodeElement(EObject context, NodeElement semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (shapeRef=JvmTypeReference (textProperties+=TextPropertyAssignment* compartmentProperties+=CompartmentPropertyAssignment*)?)
	 */
	protected void sequence_NodeFigureSection(EObject context, NodeFigureSection semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_SprayStyleRef(EObject context, SprayStyleRef semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, Spray2Package.Literals.SPRAY_STYLE_REF__STYLE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Spray2Package.Literals.SPRAY_STYLE_REF__STYLE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getSprayStyleRefAccess().getStyleJvmTypeReferenceParserRuleCall_1_0(), semanticObject.getStyle());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (key=[JvmEnumerationLiteral|QualifiedName] attribute=[EAttribute|ID] (editable=XBooleanLiteral? format=XBlockExpression?)?)
	 */
	protected void sequence_TextPropertyAssignment(EObject context, TextPropertyAssignment semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
