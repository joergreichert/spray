...
* generated by Xtext
*/
package org.eclipselabs.spray2.xtext.ui.contentassist.antlr;
...
public class Spray2Parser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.spray2.xtext.ui.contentassist.antlr.internal.InternalSpray2Parser createParser() {
		org.eclipselabs.spray2.xtext.ui.contentassist.antlr.internal.InternalSpray2Parser result = new org.eclipselabs.spray2.xtext.ui.contentassist.antlr.internal.InternalSpray2Parser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNodeElementAccess().getGroup(), "rule__NodeElement__Group__0");
					put(grammarAccess.getEdgeElementAccess().getGroup(), "rule__EdgeElement__Group__0");
					put(grammarAccess.getNodeFigureSectionAccess().getGroup(), "rule__NodeFigureSection__Group__0");
					put(grammarAccess.getNodeFigureSectionAccess().getGroup_2(), "rule__NodeFigureSection__Group_2__0");
					put(grammarAccess.getEdgeFigureSectionAccess().getGroup(), "rule__EdgeFigureSection__Group__0");
					put(grammarAccess.getEdgeFigureSectionAccess().getGroup_2(), "rule__EdgeFigureSection__Group_2__0");
					put(grammarAccess.getTextPropertyAssignmentAccess().getGroup(), "rule__TextPropertyAssignment__Group__0");
					put(grammarAccess.getTextPropertyAssignmentAccess().getGroup_4(), "rule__TextPropertyAssignment__Group_4__0");
					put(grammarAccess.getTextPropertyAssignmentAccess().getGroup_4_1(), "rule__TextPropertyAssignment__Group_4_1__0");
					put(grammarAccess.getTextPropertyAssignmentAccess().getGroup_4_2(), "rule__TextPropertyAssignment__Group_4_2__0");
					put(grammarAccess.getCompartmentPropertyAssignmentAccess().getGroup(), "rule__CompartmentPropertyAssignment__Group__0");
					...
					put(grammarAccess.getDiagramAccess().getSprayElementsAssignment_6(), "rule__Diagram__SprayElementsAssignment_6");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getSprayStyleRefAccess().getStyleAssignment_1(), "rule__SprayStyleRef__StyleAssignment_1");
					put(grammarAccess.getNodeElementAccess().getNameAssignment_1(), "rule__NodeElement__NameAssignment_1");
					put(grammarAccess.getNodeElementAccess().getTypeAssignment_3(), "rule__NodeElement__TypeAssignment_3");
					put(grammarAccess.getNodeElementAccess().getStyleAssignment_4(), "rule__NodeElement__StyleAssignment_4");
					put(grammarAccess.getNodeElementAccess().getFigureAssignment_6(), "rule__NodeElement__FigureAssignment_6");
					put(grammarAccess.getNodeElementAccess().getToolingAssignment_7(), "rule__NodeElement__ToolingAssignment_7");
					put(grammarAccess.getNodeElementAccess().getBehaviorAssignment_8(), "rule__NodeElement__BehaviorAssignment_8");
					put(grammarAccess.getEdgeElementAccess().getNameAssignment_1(), "rule__EdgeElement__NameAssignment_1");
					put(grammarAccess.getEdgeElementAccess().getTypeAssignment_3(), "rule__EdgeElement__TypeAssignment_3");
					put(grammarAccess.getEdgeElementAccess().getStyleAssignment_4(), "rule__EdgeElement__StyleAssignment_4");
					put(grammarAccess.getEdgeElementAccess().getFigureAssignment_6(), "rule__EdgeElement__FigureAssignment_6");
					put(grammarAccess.getEdgeElementAccess().getToolingAssignment_7(), "rule__EdgeElement__ToolingAssignment_7");
					put(grammarAccess.getEdgeElementAccess().getBehaviorAssignment_8(), "rule__EdgeElement__BehaviorAssignment_8");
					put(grammarAccess.getNodeFigureSectionAccess().getShapeRefAssignment_1(), "rule__NodeFigureSection__ShapeRefAssignment_1");
					put(grammarAccess.getNodeFigureSectionAccess().getTextPropertiesAssignment_2_1(), "rule__NodeFigureSection__TextPropertiesAssignment_2_1");
					put(grammarAccess.getNodeFigureSectionAccess().getCompartmentPropertiesAssignment_2_2(), "rule__NodeFigureSection__CompartmentPropertiesAssignment_2_2");
					put(grammarAccess.getEdgeFigureSectionAccess().getShapeRefAssignment_1(), "rule__EdgeFigureSection__ShapeRefAssignment_1");
					put(grammarAccess.getEdgeFigureSectionAccess().getTextPropertiesAssignment_2_1(), "rule__EdgeFigureSection__TextPropertiesAssignment_2_1");
					put(grammarAccess.getTextPropertyAssignmentAccess().getKeyAssignment_1(), "rule__TextPropertyAssignment__KeyAssignment_1");
					put(grammarAccess.getTextPropertyAssignmentAccess().getAttributeAssignment_3(), "rule__TextPropertyAssignment__AttributeAssignment_3");
					put(grammarAccess.getTextPropertyAssignmentAccess().getEditableAssignment_4_1_2(), "rule__TextPropertyAssignment__EditableAssignment_4_1_2");
					put(grammarAccess.getTextPropertyAssignmentAccess().getFormatAssignment_4_2_2(), "rule__TextPropertyAssignment__FormatAssignment_4_2_2");
					put(grammarAccess.getCompartmentPropertyAssignmentAccess().getKeyAssignment_1(), "rule__CompartmentPropertyAssignment__KeyAssignment_1");
					put(grammarAccess.getCompartmentPropertyAssignmentAccess().getAttributeAssignment_3(), "rule__CompartmentPropertyAssignment__AttributeAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.spray2.xtext.ui.contentassist.antlr.internal.InternalSpray2Parser typedParser = (org.eclipselabs.spray2.xtext.ui.contentassist.antlr.internal.InternalSpray2Parser) parser;
