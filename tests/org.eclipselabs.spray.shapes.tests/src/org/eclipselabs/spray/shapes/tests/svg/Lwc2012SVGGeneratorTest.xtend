...
class Lwc2012SVGGeneratorTest extends XtextTest {
	...
	def void testLWC_Vessel_Vertical() {
		...
		assertEquals("SVG generated for LWC_Vessel_Vertical", getExpectedSVGContent("lwc2012", "LWC_Vessel_Vertical"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Vessel_Horizontal() {
		...
		assertEquals("SVG generated for LWC_Vessel_Horizontal", getExpectedSVGContent("lwc2012", "LWC_Vessel_Horizontal"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_HeatExchanger() {
		...
		assertEquals("SVG generated for LWC_HeatExchanger", getExpectedSVGContent("lwc2012", "LWC_HeatExchanger"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Valve() {
		val element = shapeContainer.shapeContainerElement.filter(sd|"LWC_Valve".matches(sd.name)).head
		assertEquals("SVG generated for LWC_Valve", getExpectedSVGContent("lwc2012", "LWC_Valve"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Valve_Manual() {
		...
		assertEquals("SVG generated for LWC_Valve_Manual", getExpectedSVGContent("lwc2012", "LWC_Valve_Manual"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Valve_Control() {
		...
		assertEquals("SVG generated for LWC_Valve_Control", getExpectedSVGContent("lwc2012", "LWC_Valve_Control"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Pump() {
		val element = shapeContainer.shapeContainerElement.filter(sd|"LWC_Pump".matches(sd.name)).head
		assertEquals("SVG generated for LWC_Pump", getExpectedSVGContent("lwc2012", "LWC_Pump"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Pump_Vacuum() {
		...
		assertEquals("SVG generated for LWC_Pump_Vacuum", getExpectedSVGContent("lwc2012", "LWC_Pump_Vacuum"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_SystemEnd() {
		val element = shapeContainer.shapeContainerElement.filter(sd|"LWC_SystemEnd".matches(sd.name)).head
		assertEquals("SVG generated for LWC_SystemEnd", getExpectedSVGContent("lwc2012", "LWC_SystemEnd"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Joint() {
		val element = shapeContainer.shapeContainerElement.filter(sd|"LWC_Joint".matches(sd.name)).head
		assertEquals("SVG generated for LWC_Joint", getExpectedSVGContent("lwc2012", "LWC_Joint"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Location_NoLine() {
		...
		assertEquals("SVG generated for LWC_Location_NoLine", getExpectedSVGContent("lwc2012", "LWC_Location_NoLine"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Location_SolidLine() {
		...
		assertEquals("SVG generated for LWC_Location_SolidLine", getExpectedSVGContent("lwc2012", "LWC_Location_SolidLine"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Location_DashedLine() {
		...
		assertEquals("SVG generated for LWC_Location_DashedLine", getExpectedSVGContent("lwc2012", "LWC_Location_DashedLine"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Pipe() {
		val element = shapeContainer.shapeContainerElement.filter(sd|"LWC_Pipe".matches(sd.name)).head
		assertEquals("SVG generated for LWC_Pipe", getExpectedSVGContent("lwc2012", "LWC_Pipe"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
	@Test
	def void testLWC_Source_Exhaust() {
		...
		assertEquals("SVG generated for LWC_Source_Exhaust", getExpectedSVGContent("lwc2012", "LWC_Source_Exhaust"), generatorSVGDefinition.compile(element).normalizeLineEndings)
	}	
