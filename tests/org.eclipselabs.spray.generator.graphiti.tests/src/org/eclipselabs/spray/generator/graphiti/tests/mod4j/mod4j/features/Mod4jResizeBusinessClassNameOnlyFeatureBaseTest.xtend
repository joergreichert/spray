...
class Mod4jResizeBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeBusinessClassNameOnlyFeatureBase.java"
    ...
    def private expectedContent() '''
         	...
         	public abstract class Mod4jResizeBusinessClassNameOnlyFeatureBase extends DefaultResizeShapeFeature {
         	
         		SprayLayoutManager layoutManager; 
         	
         		public Mod4jResizeBusinessClassNameOnlyFeatureBase(final IFeatureProvider fp) {
         			super(fp);
