...
class Mod4jMoveBusinessClassNameOnlyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveBusinessClassNameOnlyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveBusinessClassNameOnlyFeature extends Mod4jMoveBusinessClassNameOnlyFeatureBase {
            public Mod4jMoveBusinessClassNameOnlyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
