...
class Mod4jMoveUniqueRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveUniqueRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveUniqueRuleFeature extends Mod4jMoveUniqueRuleFeatureBase {
            public Mod4jMoveUniqueRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
