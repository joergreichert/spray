...
class Mod4jAddBBBFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBBBFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddBBBFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "BBB";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddBBBFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canAdd(final IAddContext context) {
                ...
                if (newObject instanceof BusinessRule) {
            ...
            public PictogramElement add(final IAddContext context) {
                final BusinessRule addedModelElement = (BusinessRule) context.getNewObject();
                        // NEW stuff
                ...
                peService.setPropertyValue(conShape , PROPERTY_ALIAS, "BBB");
            ...
            protected void linkShapes(ContainerShape conShape, BusinessRule addedModelElement) {
                link(conShape, addedModelElement);
