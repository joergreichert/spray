...
class Mod4jDeleteReferenceBusinessClassSuperclassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDeleteReferenceBusinessClassSuperclassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDeleteReferenceBusinessClassSuperclassFeature extends Mod4jDeleteReferenceBusinessClassSuperclassFeatureBase {
            public Mod4jDeleteReferenceBusinessClassSuperclassFeature(final IFeatureProvider fp) {
                super(fp);
            }
