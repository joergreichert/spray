...
class Mod4jMoveBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveBusinessRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveBusinessRuleFeature extends Mod4jMoveBusinessRuleFeatureBase {
            public Mod4jMoveBusinessRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
