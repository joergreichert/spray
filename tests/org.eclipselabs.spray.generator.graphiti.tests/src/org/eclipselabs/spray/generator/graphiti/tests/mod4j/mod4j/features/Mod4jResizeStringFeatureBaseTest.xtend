...
class Mod4jResizeStringFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeStringFeatureBase.java"
    ...
    def private expectedContent() '''
         	...
         	public abstract class Mod4jResizeStringFeatureBase extends DefaultResizeShapeFeature {
         	
         		SprayLayoutManager layoutManager; 
         	
         		public Mod4jResizeStringFeatureBase(final IFeatureProvider fp) {
         			super(fp);
