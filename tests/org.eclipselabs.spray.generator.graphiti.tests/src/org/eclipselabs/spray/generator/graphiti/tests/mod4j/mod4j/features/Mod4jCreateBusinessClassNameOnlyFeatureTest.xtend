...
class Mod4jCreateBusinessClassNameOnlyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBusinessClassNameOnlyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateBusinessClassNameOnlyFeature extends Mod4jCreateBusinessClassNameOnlyFeatureBase {
            public Mod4jCreateBusinessClassNameOnlyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
