...
class Mod4jAddBoolPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBoolPropertyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddBoolPropertyFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "BoolProperty";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddBoolPropertyFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canAdd(final IAddContext context) {
                ...
                if (newObject instanceof BoolProperty) {
            ...
            public PictogramElement add(final IAddContext context) {
                final BoolProperty addedModelElement = (BoolProperty) context.getNewObject();
                        // NEW stuff
            ...
            protected void linkShapes(ContainerShape conShape, BoolProperty addedModelElement) {
                link(conShape, addedModelElement);
