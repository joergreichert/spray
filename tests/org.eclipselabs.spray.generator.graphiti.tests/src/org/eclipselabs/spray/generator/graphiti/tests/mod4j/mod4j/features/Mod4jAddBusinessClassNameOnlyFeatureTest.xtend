...
class Mod4jAddBusinessClassNameOnlyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBusinessClassNameOnlyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddBusinessClassNameOnlyFeature extends Mod4jAddBusinessClassNameOnlyFeatureBase {
            public Mod4jAddBusinessClassNameOnlyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
