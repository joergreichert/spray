...
class Mod4jCreateStringPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateStringPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateStringPropertyFeature extends Mod4jCreateStringPropertyFeatureBase {
            public Mod4jCreateStringPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
