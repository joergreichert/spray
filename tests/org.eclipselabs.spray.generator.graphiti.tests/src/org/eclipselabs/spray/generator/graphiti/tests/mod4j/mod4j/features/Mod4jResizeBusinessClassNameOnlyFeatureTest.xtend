...
class Mod4jResizeBusinessClassNameOnlyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeBusinessClassNameOnlyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeBusinessClassNameOnlyFeature extends Mod4jResizeBusinessClassNameOnlyFeatureBase {
            public Mod4jResizeBusinessClassNameOnlyFeature(final IFeatureProvider fp) {
                super(fp);
            }
