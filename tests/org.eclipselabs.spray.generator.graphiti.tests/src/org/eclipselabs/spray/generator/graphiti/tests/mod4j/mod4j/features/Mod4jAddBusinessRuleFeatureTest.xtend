...
class Mod4jAddBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBusinessRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddBusinessRuleFeature extends Mod4jAddBusinessRuleFeatureBase {
            public Mod4jAddBusinessRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
