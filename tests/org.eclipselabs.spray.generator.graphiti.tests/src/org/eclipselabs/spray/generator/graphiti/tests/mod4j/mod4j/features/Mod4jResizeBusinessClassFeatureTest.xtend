...
class Mod4jResizeBusinessClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeBusinessClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeBusinessClassFeature extends Mod4jResizeBusinessClassFeatureBase {
            public Mod4jResizeBusinessClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
