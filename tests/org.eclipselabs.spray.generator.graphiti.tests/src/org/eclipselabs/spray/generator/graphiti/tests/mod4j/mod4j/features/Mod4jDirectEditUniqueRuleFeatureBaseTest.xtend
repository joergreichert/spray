...
class Mod4jDirectEditUniqueRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditUniqueRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jDirectEditUniqueRuleFeatureBase extends AbstractDirectEditingFeature {
        
            protected IPeService peService = Graphiti.getPeService();
        
            public Mod4jDirectEditUniqueRuleFeatureBase(IFeatureProvider fp) {
                super(fp);
            }
            ...
            public boolean canDirectEdit(IDirectEditingContext context) {
                ...
                // support direct editing, if it is a UniqueRule, and the user clicked
                // directly on the text and not somewhere else in the rectangle
                if (bo instanceof UniqueRule && ga instanceof AbstractText) {
                    return true;
                }
            ...
            public String getInitialValue(IDirectEditingContext context) {
                // return the initial value of the clicked text on the UniqueRule
                PictogramElement pe = context.getPictogramElement();
                UniqueRule eClass = (UniqueRule) getBusinessObjectForPictogramElement(pe);
            ...
            public void setValue(final String value, final IDirectEditingContext context) {
                // set the new value on the UniqueRule
