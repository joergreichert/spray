...
class Mod4jMovePackageFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMovePackageFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jMovePackageFeatureBase extends DefaultMoveShapeFeature {
        
            SprayLayoutManager layoutManager; 
        
            public Mod4jMovePackageFeatureBase(final IFeatureProvider fp) {
                super(fp);
