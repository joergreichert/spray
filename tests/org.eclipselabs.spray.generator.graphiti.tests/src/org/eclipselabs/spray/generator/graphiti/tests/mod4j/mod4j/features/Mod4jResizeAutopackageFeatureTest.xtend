...
class Mod4jResizeAutopackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeAutopackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeAutopackageFeature extends Mod4jResizeAutopackageFeatureBase {
            public Mod4jResizeAutopackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
