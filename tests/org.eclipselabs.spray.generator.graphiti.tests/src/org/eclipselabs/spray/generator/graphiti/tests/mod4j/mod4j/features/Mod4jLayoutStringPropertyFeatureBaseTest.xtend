...
class Mod4jLayoutStringPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutStringPropertyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jLayoutStringPropertyFeatureBase extends AbstractLayoutFeature {
        	
        	SprayLayoutManager layoutManager; 
        
            public Mod4jLayoutStringPropertyFeatureBase(final IFeatureProvider fp) {
                super(fp);
