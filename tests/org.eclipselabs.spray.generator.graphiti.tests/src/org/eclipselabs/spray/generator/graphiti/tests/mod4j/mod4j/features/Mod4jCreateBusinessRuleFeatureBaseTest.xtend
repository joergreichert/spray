...
class Mod4jCreateBusinessRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBusinessRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jCreateBusinessRuleFeatureBase extends AbstractCreateFeature {
            ...
            public Mod4jCreateBusinessRuleFeatureBase (final IFeatureProvider fp) {
                // set name and description of the creation feature
                super(fp, "BusinessRule", "Create new BusinessRule");
            ...
            public Object[] create(final ICreateContext context) {
                newClass = createBusinessRule(context);
            ...
            //        
                     ...
                     */
                    protected BusinessRule createBusinessRule(final ICreateContext context) {
