...
class Mod4jCreateBoolPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBoolPropertyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jCreateBoolPropertyFeatureBase extends AbstractCreateFeature {
            ...
            protected BoolProperty newClass = null;
        
        
            public Mod4jCreateBoolPropertyFeatureBase (final IFeatureProvider fp) {
                // set name and description of the creation feature
                super(fp, "BoolProperty", "Create new BoolProperty");
            ...
            public Object[] create(final ICreateContext context) {
                newClass = createBoolProperty(context);
            ...
            //        
                    ...
                    /**
                     * Creates a new {@link BoolProperty} instance and adds it to the containing type.
                     */
                    protected BoolProperty createBoolProperty(final ICreateContext context) {
                        // create BoolProperty instance
                        final BoolProperty newClass = BusinessDomainDslFactory.eINSTANCE.createBoolProperty();
