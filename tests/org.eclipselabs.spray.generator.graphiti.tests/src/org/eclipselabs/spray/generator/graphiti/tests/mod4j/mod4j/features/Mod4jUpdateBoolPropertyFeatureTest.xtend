...
class Mod4jUpdateBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBoolPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateBoolPropertyFeature extends Mod4jUpdateBoolPropertyFeatureBase {
            public Mod4jUpdateBoolPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
