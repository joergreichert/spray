...
class Mod4jDirectEditStringFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditStringFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditStringFeature extends Mod4jDirectEditStringFeatureBase {
            public Mod4jDirectEditStringFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
