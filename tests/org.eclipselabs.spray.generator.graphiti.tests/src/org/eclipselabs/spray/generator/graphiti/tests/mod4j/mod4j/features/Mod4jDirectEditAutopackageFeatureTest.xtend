...
class Mod4jDirectEditAutopackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditAutopackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditAutopackageFeature extends Mod4jDirectEditAutopackageFeatureBase {
            public Mod4jDirectEditAutopackageFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
