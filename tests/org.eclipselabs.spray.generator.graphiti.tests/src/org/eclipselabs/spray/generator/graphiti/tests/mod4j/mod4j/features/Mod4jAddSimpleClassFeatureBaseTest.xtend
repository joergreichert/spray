...
class Mod4jAddSimpleClassFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddSimpleClassFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddSimpleClassFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "SimpleClass";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddSimpleClassFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public PictogramElement add(final IAddContext context) {
                ...
                peService.setPropertyValue(conShape , PROPERTY_ALIAS, "SimpleClass");
