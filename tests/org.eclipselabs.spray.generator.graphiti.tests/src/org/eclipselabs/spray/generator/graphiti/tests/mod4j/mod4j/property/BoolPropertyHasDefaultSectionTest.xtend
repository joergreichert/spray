...
class BoolPropertyHasDefaultSectionTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/BoolPropertyHasDefaultSection.java"
    ...
    def private expectedContent() '''
        ...
        public class BoolPropertyHasDefaultSection extends BoolPropertyHasDefaultSectionBase {
