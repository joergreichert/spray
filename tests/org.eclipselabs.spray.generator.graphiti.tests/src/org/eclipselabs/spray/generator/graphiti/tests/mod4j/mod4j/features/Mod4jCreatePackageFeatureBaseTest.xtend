...
class Mod4jCreatePackageFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreatePackageFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jCreatePackageFeatureBase extends AbstractCreateFeature {
            ...
            public Mod4jCreatePackageFeatureBase (final IFeatureProvider fp) {
                // set name and description of the creation feature
                super(fp, "Package", "Create new Package");
            ...
            public Object[] create(final ICreateContext context) {
                newClass = createPackage(context);
            ...
            //       org.eclipse.emf.ecore.impl.EReferenceImpl@4f7967de (name: packages) (ordered: true, unique: true, lowerBound: 0, upperBound: -1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (containment: true, resolveProxies: false) 
                     ...
                     */
                    protected samplepackage.Package createPackage(final ICreateContext context) {
