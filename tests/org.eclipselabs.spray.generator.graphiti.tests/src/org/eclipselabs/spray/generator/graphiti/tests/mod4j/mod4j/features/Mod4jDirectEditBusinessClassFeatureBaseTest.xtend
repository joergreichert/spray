...
class Mod4jDirectEditBusinessClassFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditBusinessClassFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jDirectEditBusinessClassFeatureBase extends AbstractDirectEditingFeature {
        
            protected IPeService peService = Graphiti.getPeService();
        
            public Mod4jDirectEditBusinessClassFeatureBase(IFeatureProvider fp) {
                super(fp);
            }
