...
class Mod4jUpdateUniqueRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateUniqueRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jUpdateUniqueRuleFeatureBase extends AbstractUpdateFeature {
            public Mod4jUpdateUniqueRuleFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canUpdate(final IUpdateContext context) {
                // return true, if linked business object is a UniqueRule
                final PictogramElement pictogramElement = context.getPictogramElement();
                final Object bo = getBusinessObjectForPictogramElement(pictogramElement);
                return (bo instanceof UniqueRule) && (!(pictogramElement instanceof Diagram));
            }
            ...
            public IReason updateNeeded(final IUpdateContext context) {
                final PictogramElement pictogramElement = context.getPictogramElement();
                final Object bo = getBusinessObjectForPictogramElement(pictogramElement);
                if (!(bo instanceof UniqueRule)) {
                    return Reason.createFalseReason();
                }
                if (pictogramElement instanceof Shape) {
                    Shape shape = (Shape) pictogramElement;
                    UniqueRule eClass = (UniqueRule) bo;
            ...
            protected boolean checkUpdateNeededRecursively(Shape shape, final UniqueRule eClass) {
                ...
                if (graphicsAlgorithm instanceof AbstractText) {
                    ...
                    if (id != null) {
                        if (id.equals("uniqueRuleName")) {
                            String eClassValue = new Function<UniqueRule, String>() {
                                public String apply(UniqueRule modelElement) {
            ...
            public boolean update(final IUpdateContext context) {
                final PictogramElement pictogramElement = context.getPictogramElement();
                final UniqueRule eClass = (UniqueRule) getBusinessObjectForPictogramElement(pictogramElement);
                if (pictogramElement instanceof Shape) {
                    Shape shape = (Shape) pictogramElement;
            ...
            protected void updateChildrenRecursively(Shape shape, final UniqueRule eClass) {
                GraphicsAlgorithm graphicsAlgorithm = shape.getGraphicsAlgorithm();
                if (graphicsAlgorithm instanceof AbstractText) {
                    AbstractText text = (AbstractText) graphicsAlgorithm;
                    String id = peService.getPropertyValue(graphicsAlgorithm, TEXT_ID);
                    if (id != null) {
                        if (id.equals("uniqueRuleName")) {
                            String value = new Function<UniqueRule, String>() {
                                public String apply(UniqueRule modelElement) {
                                    // generation exception: java.lang.NullPointerException
                                }
                            }.apply(eClass);
