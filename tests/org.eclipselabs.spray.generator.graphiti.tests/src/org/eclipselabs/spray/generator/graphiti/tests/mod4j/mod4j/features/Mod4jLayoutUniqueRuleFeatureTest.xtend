...
class Mod4jLayoutUniqueRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutUniqueRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutUniqueRuleFeature extends Mod4jLayoutUniqueRuleFeatureBase {
            public Mod4jLayoutUniqueRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
