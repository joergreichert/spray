...
class Mod4jCreateStringFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateStringFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jCreateStringFeatureBase extends AbstractCreateFeature {
            ...
            public Mod4jCreateStringFeatureBase (final IFeatureProvider fp) {
                // set name and description of the creation feature
                super(fp, "String", "Create new String");
            ...
            //        
                     ...
                     */
                    protected StringProperty createString(final ICreateContext context) {
            ...
            protected PictogramElement addGraphicalRepresentation(final IAreaContext context, final Object newObject) {
                ...
                ctx.putProperty(PROPERTY_ALIAS, "String");
