...
class Mod4jDirectEditSimpleClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditSimpleClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditSimpleClassFeature extends Mod4jDirectEditSimpleClassFeatureBase {
            public Mod4jDirectEditSimpleClassFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
