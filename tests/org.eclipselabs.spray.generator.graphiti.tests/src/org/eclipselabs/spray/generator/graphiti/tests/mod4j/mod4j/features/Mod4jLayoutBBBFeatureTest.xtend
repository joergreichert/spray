...
class Mod4jLayoutBBBFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBBBFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutBBBFeature extends Mod4jLayoutBBBFeatureBase {
            public Mod4jLayoutBBBFeature(final IFeatureProvider fp) {
                super(fp);
            }
