...
class Mod4jAddPackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddPackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddPackageFeature extends Mod4jAddPackageFeatureBase {
            public Mod4jAddPackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
