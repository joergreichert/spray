...
class PackageNameSectionBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/PackageNameSectionBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class PackageNameSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
