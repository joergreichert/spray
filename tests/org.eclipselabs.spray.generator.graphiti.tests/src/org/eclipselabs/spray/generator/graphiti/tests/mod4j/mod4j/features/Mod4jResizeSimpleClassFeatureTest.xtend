...
class Mod4jResizeSimpleClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeSimpleClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeSimpleClassFeature extends Mod4jResizeSimpleClassFeatureBase {
            public Mod4jResizeSimpleClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
