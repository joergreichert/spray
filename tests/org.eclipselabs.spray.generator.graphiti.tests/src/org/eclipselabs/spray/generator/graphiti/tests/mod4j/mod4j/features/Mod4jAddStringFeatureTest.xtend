...
class Mod4jAddStringFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddStringFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddStringFeature extends Mod4jAddStringFeatureBase {
            public Mod4jAddStringFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
