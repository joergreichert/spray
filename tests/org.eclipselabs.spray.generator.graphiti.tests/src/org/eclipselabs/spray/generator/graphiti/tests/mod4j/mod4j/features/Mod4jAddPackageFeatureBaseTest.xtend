...
class Mod4jAddPackageFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddPackageFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddPackageFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "Package";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddPackageFeatureBase(final IFeatureProvider fp) {
                super(fp);
