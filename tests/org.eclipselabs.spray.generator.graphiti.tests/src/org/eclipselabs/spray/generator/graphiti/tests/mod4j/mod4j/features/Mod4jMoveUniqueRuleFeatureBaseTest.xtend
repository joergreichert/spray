...
class Mod4jMoveUniqueRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveUniqueRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jMoveUniqueRuleFeatureBase extends DefaultMoveShapeFeature {
        
            SprayLayoutManager layoutManager; 
        
            public Mod4jMoveUniqueRuleFeatureBase(final IFeatureProvider fp) {
                super(fp);
                ...
                if (target instanceof BusinessClass) {
                    if (SprayLayoutService.isCompartment(targetContainer) ) {
                        ...
                        if ((id != null) && (id.equals("businessrules"))) {
                            ...
                            ((BusinessClass) target).getBusinessRules().add((UniqueRule) source);
