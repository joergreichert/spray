...
class Mod4jCustomRedrawFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCustomRedrawFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCustomRedrawFeature extends Mod4jCustomRedrawFeatureBase {
            public Mod4jCustomRedrawFeature(final IFeatureProvider fp) {
                super(fp);
            }
