...
class Mod4jResizeUniqueRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeUniqueRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeUniqueRuleFeature extends Mod4jResizeUniqueRuleFeatureBase {
            public Mod4jResizeUniqueRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
