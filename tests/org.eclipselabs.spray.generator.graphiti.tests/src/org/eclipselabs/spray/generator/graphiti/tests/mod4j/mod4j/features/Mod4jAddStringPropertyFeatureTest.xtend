...
class Mod4jAddStringPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddStringPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddStringPropertyFeature extends Mod4jAddStringPropertyFeatureBase {
            public Mod4jAddStringPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
