...
class Mod4jMovePackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMovePackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMovePackageFeature extends Mod4jMovePackageFeatureBase {
            public Mod4jMovePackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
