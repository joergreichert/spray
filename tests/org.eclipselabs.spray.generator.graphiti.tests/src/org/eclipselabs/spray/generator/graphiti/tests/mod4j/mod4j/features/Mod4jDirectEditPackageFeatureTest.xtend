...
class Mod4jDirectEditPackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditPackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditPackageFeature extends Mod4jDirectEditPackageFeatureBase {
            public Mod4jDirectEditPackageFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
