...
class Mod4jResizeBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeBusinessRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeBusinessRuleFeature extends Mod4jResizeBusinessRuleFeatureBase {
            public Mod4jResizeBusinessRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
