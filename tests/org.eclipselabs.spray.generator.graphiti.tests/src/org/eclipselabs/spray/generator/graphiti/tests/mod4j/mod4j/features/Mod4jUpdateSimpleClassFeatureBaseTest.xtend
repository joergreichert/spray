...
class Mod4jUpdateSimpleClassFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateSimpleClassFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jUpdateSimpleClassFeatureBase extends AbstractUpdateFeature {
            public Mod4jUpdateSimpleClassFeatureBase(final IFeatureProvider fp) {
                super(fp);
