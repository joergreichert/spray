...
class Mod4jDirectEditAssociationFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditAssociationFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jDirectEditAssociationFeatureBase extends AbstractDirectEditingFeature {
        
            protected IPeService peService = Graphiti.getPeService();
        
            public Mod4jDirectEditAssociationFeatureBase(IFeatureProvider fp) {
                super(fp);
            }
            ...
            public boolean canDirectEdit(IDirectEditingContext context) {
                ...
                // support direct editing, if it is a Association, and the user clicked
                // directly on the text and not somewhere else in the rectangle
                if (bo instanceof Association && ga instanceof AbstractText) {
                    return true;
                }
            ...
            public String getInitialValue(IDirectEditingContext context) {
                // return the initial value of the clicked text on the Association
                PictogramElement pe = context.getPictogramElement();
                Association eClass = (Association) getBusinessObjectForPictogramElement(pe);
            ...
            public void setValue(final String value, final IDirectEditingContext context) {
                // set the new value on the Association
