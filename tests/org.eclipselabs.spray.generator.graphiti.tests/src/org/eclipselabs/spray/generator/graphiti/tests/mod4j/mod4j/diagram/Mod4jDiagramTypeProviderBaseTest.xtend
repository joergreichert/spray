...
class Mod4jDiagramTypeProviderBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/diagram/Mod4jDiagramTypeProviderBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jDiagramTypeProviderBase extends AbstractDiagramTypeProvider {
            ...
            public IToolBehaviorProvider[] getAvailableToolBehaviorProviders() {
                if (toolBehaviorProviders == null) {
                    toolBehaviorProviders = new IToolBehaviorProvider[]{new Mod4jToolBehaviorProvider(this)};
                }
