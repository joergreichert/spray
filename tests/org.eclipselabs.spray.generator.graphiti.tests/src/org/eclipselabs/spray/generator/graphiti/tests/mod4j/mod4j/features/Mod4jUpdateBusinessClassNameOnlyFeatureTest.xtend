...
class Mod4jUpdateBusinessClassNameOnlyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBusinessClassNameOnlyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateBusinessClassNameOnlyFeature extends Mod4jUpdateBusinessClassNameOnlyFeatureBase {
            public Mod4jUpdateBusinessClassNameOnlyFeature(final IFeatureProvider fp) {
                super(fp);
            }
