...
class AssociationCompositeSectionBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/AssociationCompositeSectionBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class AssociationCompositeSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
        
            protected Association bc = null;
            protected CCombo      compositeWidget;
            ...
            public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
                ...
                compositeWidget = factory.createCCombo(composite);
                data = new FormData();
                data.left = new FormAttachment(0, STANDARD_LABEL_WIDTH);
                data.right = new FormAttachment(100, 0);
                data.top = new FormAttachment(0, VSPACE);
                compositeWidget.setLayoutData(data);
        
                CLabel valueLabel = factory.createCLabel(composite, "Composite");
                data = new FormData();
                data.left = new FormAttachment(0, 0);
                data.right = new FormAttachment(compositeWidget, -HSPACE);
                data.top = new FormAttachment(compositeWidget, 0, SWT.CENTER);
            ...
            @Override
            public void refresh() {
                compositeWidget.removeSelectionListener(nameListener);
                compositeWidget.setItems(getEnumerationFeatureValues());
                compositeWidget.setText(getFeatureAsText());
                compositeWidget.addSelectionListener(nameListener);
            }
            ...
            //        value = ( bc.isComposite() ? "true" : "false" );
            ...
            protected String getFeatureAsText() {
                ...
                if (pe != null) {
                    ...
                    bc = (Association) bo;
                    return (bc.isComposite() ? "true" : "false");
                }
                return "unknown ";
            }
            ...
            protected void changePropertyValue() {
                int index = compositeWidget.getSelectionIndex();
                boolean newValue = (index == 0 ? false : true);
                if (newValue != bc.isComposite()) {
                    bc.setComposite(newValue);
                }
            }
        }
    '''
