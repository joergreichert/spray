...
class Mod4jUpdatePackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdatePackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdatePackageFeature extends Mod4jUpdatePackageFeatureBase {
            public Mod4jUpdatePackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
