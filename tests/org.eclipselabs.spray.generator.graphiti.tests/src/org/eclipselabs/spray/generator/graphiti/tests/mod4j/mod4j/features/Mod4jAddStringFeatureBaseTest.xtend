...
class Mod4jAddStringFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddStringFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddStringFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "String";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddStringFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canAdd(final IAddContext context) {
                ...
                if (newObject instanceof StringProperty) {
                    ...
                    if (context.getTargetContainer() instanceof Diagram) {
                        ...
                        if( target instanceof samplepackage.UniqueRule ){
                            if (SprayLayoutService.isCompartment(context.getTargetContainer())) {
                                String id = GraphitiProperties.get(context.getTargetContainer(), TEXT_ID);
            ...
            public PictogramElement add(final IAddContext context) {
                final StringProperty addedModelElement = (StringProperty) context.getNewObject();
                        // NEW stuff
                ...
                peService.setPropertyValue(conShape , PROPERTY_ALIAS, "String");
            ...
            protected void linkShapes(ContainerShape conShape, StringProperty addedModelElement) {
                link(conShape, addedModelElement);
