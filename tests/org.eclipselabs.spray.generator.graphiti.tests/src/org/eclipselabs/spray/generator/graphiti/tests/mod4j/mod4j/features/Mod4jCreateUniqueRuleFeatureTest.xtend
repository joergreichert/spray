...
class Mod4jCreateUniqueRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateUniqueRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateUniqueRuleFeature extends Mod4jCreateUniqueRuleFeatureBase {
            public Mod4jCreateUniqueRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
