...
class Mod4jCreateUniqueRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateUniqueRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jCreateUniqueRuleFeatureBase extends AbstractCreateFeature {
            ...
            protected UniqueRule newClass = null;
        
        
            public Mod4jCreateUniqueRuleFeatureBase (final IFeatureProvider fp) {
                // set name and description of the creation feature
                super(fp, "UniqueRule", "Create new UniqueRule");
            ...
            public Object[] create(final ICreateContext context) {
                newClass = createUniqueRule(context);
            ...
            //        
                    ...
                    /**
                     * Creates a new {@link UniqueRule} instance and adds it to the containing type.
                     */
                    protected UniqueRule createUniqueRule(final ICreateContext context) {
                        // create UniqueRule instance
                        final UniqueRule newClass = BusinessDomainDslFactory.eINSTANCE.createUniqueRule();
