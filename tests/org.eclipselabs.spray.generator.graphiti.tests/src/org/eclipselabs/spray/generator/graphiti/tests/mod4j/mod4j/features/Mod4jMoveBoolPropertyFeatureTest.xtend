...
class Mod4jMoveBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveBoolPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveBoolPropertyFeature extends Mod4jMoveBoolPropertyFeatureBase {
            public Mod4jMoveBoolPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
