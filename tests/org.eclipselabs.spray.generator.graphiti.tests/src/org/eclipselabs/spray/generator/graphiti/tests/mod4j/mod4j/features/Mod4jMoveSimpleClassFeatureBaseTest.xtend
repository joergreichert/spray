...
class Mod4jMoveSimpleClassFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveSimpleClassFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jMoveSimpleClassFeatureBase extends DefaultMoveShapeFeature {
        
            SprayLayoutManager layoutManager; 
        
            public Mod4jMoveSimpleClassFeatureBase(final IFeatureProvider fp) {
                super(fp);
