...
class StringPropertyHasDefaultSectionBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/StringPropertyHasDefaultSectionBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class StringPropertyHasDefaultSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
