...
class Mod4jMoveStringFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveStringFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveStringFeature extends Mod4jMoveStringFeatureBase {
            public Mod4jMoveStringFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
