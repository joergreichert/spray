...
class Mod4jDirectEditBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditBusinessRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditBusinessRuleFeature extends Mod4jDirectEditBusinessRuleFeatureBase {
            public Mod4jDirectEditBusinessRuleFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
