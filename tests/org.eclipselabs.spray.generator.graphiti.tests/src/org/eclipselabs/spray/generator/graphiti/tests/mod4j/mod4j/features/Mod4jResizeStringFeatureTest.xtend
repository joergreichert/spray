...
class Mod4jResizeStringFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeStringFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeStringFeature extends Mod4jResizeStringFeatureBase {
            public Mod4jResizeStringFeature(final IFeatureProvider fp) {
                super(fp);
            }
