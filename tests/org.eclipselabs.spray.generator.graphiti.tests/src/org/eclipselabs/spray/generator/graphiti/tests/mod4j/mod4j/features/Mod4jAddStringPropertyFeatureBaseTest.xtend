...
class Mod4jAddStringPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddStringPropertyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddStringPropertyFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "StringProperty";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddStringPropertyFeatureBase(final IFeatureProvider fp) {
                super(fp);
