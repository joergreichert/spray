...
class Mod4jCopyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCopyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCopyFeature extends Mod4jCopyFeatureBase {
            public Mod4jCopyFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
