...
class Mod4jPasteFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jPasteFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jPasteFeature extends Mod4jPasteFeatureBase {
            public Mod4jPasteFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
