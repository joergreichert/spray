...
class AssociationDescriptionSectionBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/AssociationDescriptionSectionBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class AssociationDescriptionSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
