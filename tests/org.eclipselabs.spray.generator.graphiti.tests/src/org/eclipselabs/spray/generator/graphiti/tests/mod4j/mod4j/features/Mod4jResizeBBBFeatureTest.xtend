...
class Mod4jResizeBBBFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeBBBFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeBBBFeature extends Mod4jResizeBBBFeatureBase {
            public Mod4jResizeBBBFeature(final IFeatureProvider fp) {
                super(fp);
            }
