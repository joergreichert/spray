...
class Mod4jCreateBusinessClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBusinessClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateBusinessClassFeature extends Mod4jCreateBusinessClassFeatureBase {
            public Mod4jCreateBusinessClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
