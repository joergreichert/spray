...
class Mod4jResizePackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizePackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizePackageFeature extends Mod4jResizePackageFeatureBase {
            public Mod4jResizePackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
