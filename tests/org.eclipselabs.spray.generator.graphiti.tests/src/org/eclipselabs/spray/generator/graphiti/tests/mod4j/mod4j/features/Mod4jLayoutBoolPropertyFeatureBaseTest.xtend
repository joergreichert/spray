...
class Mod4jLayoutBoolPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBoolPropertyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jLayoutBoolPropertyFeatureBase extends AbstractLayoutFeature {
        	
        	SprayLayoutManager layoutManager; 
        
            public Mod4jLayoutBoolPropertyFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canLayout(final ILayoutContext context) {
               ...
               return (businessObjects.size() == 1) && (businessObjects.get(0) instanceof BoolProperty);
            }
            /**
             * {@inheritDoc}
             */
