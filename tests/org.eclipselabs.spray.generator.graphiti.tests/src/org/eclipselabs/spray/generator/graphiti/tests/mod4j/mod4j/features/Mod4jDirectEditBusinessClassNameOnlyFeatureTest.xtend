...
class Mod4jDirectEditBusinessClassNameOnlyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditBusinessClassNameOnlyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditBusinessClassNameOnlyFeature extends Mod4jDirectEditBusinessClassNameOnlyFeatureBase {
            public Mod4jDirectEditBusinessClassNameOnlyFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
