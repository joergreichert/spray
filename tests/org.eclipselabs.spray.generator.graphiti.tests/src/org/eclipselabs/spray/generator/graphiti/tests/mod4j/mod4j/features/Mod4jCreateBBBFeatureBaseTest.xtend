...
class Mod4jCreateBBBFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBBBFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jCreateBBBFeatureBase extends AbstractCreateFeature {
            ...
            protected BusinessRule newClass = null;
        
        
            public Mod4jCreateBBBFeatureBase (final IFeatureProvider fp) {
                // set name and description of the creation feature
                super(fp, "BBB", "Create new BBB");
            ...
            //        
                    ...
                    /**
                     * Creates a new {@link BusinessRule} instance and adds it to the containing type.
                     */
                    protected BusinessRule createBBB(final ICreateContext context) {
                        // create BusinessRule instance
                        final BusinessRule newClass = BusinessDomainDslFactory.eINSTANCE.createBusinessRule();
            ...
            //              And now the NEW stuff
                           if( target instanceof samplepackage.BusinessClass ){
                               samplepackage.BusinessClass domainObject = (samplepackage.BusinessClass) target;
                                   // containment
                                   domainObject.getBusinessRules().add(newClass);
                                   setDoneChanges(true);
                                   return newClass;
                               }
                           if( target instanceof samplepackage.BusinessClass ){
            ...
            protected PictogramElement addGraphicalRepresentation(final IAreaContext context, final Object newObject) {
                ...
                ctx.putProperty(PROPERTY_ALIAS, "BBB");
