...
class Mod4jUpdateAssociationFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateAssociationFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateAssociationFeature extends Mod4jUpdateAssociationFeatureBase {
            public Mod4jUpdateAssociationFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
