...
class UniqueRuleNameSectionBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/UniqueRuleNameSectionBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class UniqueRuleNameSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
