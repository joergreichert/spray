...
class Mod4jUpdateAutopackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateAutopackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateAutopackageFeature extends Mod4jUpdateAutopackageFeatureBase {
            public Mod4jUpdateAutopackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
