...
class Mod4jFeatureProviderTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/diagram/Mod4jFeatureProvider.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jFeatureProvider extends Mod4jFeatureProviderBase {
        
            public Mod4jFeatureProvider(final IDiagramTypeProvider dtp) {
                super(dtp);
            }
