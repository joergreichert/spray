...
class Mod4jUpdateStringFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateStringFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateStringFeature extends Mod4jUpdateStringFeatureBase {
            public Mod4jUpdateStringFeature(final IFeatureProvider fp) {
                super(fp);
            }
