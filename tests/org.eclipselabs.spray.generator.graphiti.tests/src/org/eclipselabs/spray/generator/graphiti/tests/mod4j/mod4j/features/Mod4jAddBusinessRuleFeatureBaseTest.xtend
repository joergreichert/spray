...
class Mod4jAddBusinessRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBusinessRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddBusinessRuleFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "BusinessRule";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddBusinessRuleFeatureBase(final IFeatureProvider fp) {
                super(fp);
