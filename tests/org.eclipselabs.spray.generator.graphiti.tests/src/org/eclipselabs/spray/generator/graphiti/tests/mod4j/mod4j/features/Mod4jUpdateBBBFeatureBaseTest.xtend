...
class Mod4jUpdateBBBFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBBBFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jUpdateBBBFeatureBase extends AbstractUpdateFeature {
            public Mod4jUpdateBBBFeatureBase(final IFeatureProvider fp) {
                super(fp);
