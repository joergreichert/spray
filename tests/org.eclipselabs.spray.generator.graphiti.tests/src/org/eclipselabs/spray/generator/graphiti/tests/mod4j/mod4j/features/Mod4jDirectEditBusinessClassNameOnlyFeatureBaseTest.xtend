...
class Mod4jDirectEditBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditBusinessClassNameOnlyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jDirectEditBusinessClassNameOnlyFeatureBase extends AbstractDirectEditingFeature {
        
            protected IPeService peService = Graphiti.getPeService();
        
            public Mod4jDirectEditBusinessClassNameOnlyFeatureBase(IFeatureProvider fp) {
                super(fp);
            }
            ...
            public boolean canDirectEdit(IDirectEditingContext context) {
                ...
                if (bo instanceof BusinessClass && ga instanceof AbstractText) {
                    return true;
                }
