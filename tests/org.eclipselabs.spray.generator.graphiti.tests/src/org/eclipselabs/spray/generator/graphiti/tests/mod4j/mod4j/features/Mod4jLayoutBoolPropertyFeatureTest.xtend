...
class Mod4jLayoutBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBoolPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutBoolPropertyFeature extends Mod4jLayoutBoolPropertyFeatureBase {
            public Mod4jLayoutBoolPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
