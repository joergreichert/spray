...
class Mod4jLayoutBusinessClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBusinessClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutBusinessClassFeature extends Mod4jLayoutBusinessClassFeatureBase {
            public Mod4jLayoutBusinessClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
