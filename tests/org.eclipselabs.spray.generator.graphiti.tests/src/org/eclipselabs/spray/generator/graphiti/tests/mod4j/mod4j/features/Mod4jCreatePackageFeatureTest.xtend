...
class Mod4jCreatePackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreatePackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreatePackageFeature extends Mod4jCreatePackageFeatureBase {
            public Mod4jCreatePackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
