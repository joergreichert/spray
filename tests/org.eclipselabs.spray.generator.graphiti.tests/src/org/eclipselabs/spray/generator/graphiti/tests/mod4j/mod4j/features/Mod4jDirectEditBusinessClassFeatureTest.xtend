...
class Mod4jDirectEditBusinessClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditBusinessClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditBusinessClassFeature extends Mod4jDirectEditBusinessClassFeatureBase {
            public Mod4jDirectEditBusinessClassFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
