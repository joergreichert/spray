...
class Mod4jCreateStringFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateStringFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateStringFeature extends Mod4jCreateStringFeatureBase {
            public Mod4jCreateStringFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
