...
class Mod4jResizeBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeBoolPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeBoolPropertyFeature extends Mod4jResizeBoolPropertyFeatureBase {
            public Mod4jResizeBoolPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
