...
class Mod4jResizePackageFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizePackageFeatureBase.java"
    ...
    def private expectedContent() '''
         	...
         	public abstract class Mod4jResizePackageFeatureBase extends DefaultResizeShapeFeature {
         	
         		SprayLayoutManager layoutManager; 
         	
         		public Mod4jResizePackageFeatureBase(final IFeatureProvider fp) {
         			super(fp);
