...
class AssociationSourceRoleNameSectionBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/AssociationSourceRoleNameSectionBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class AssociationSourceRoleNameSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
