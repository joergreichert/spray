...
class Mod4jMoveStringPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveStringPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveStringPropertyFeature extends Mod4jMoveStringPropertyFeatureBase {
            public Mod4jMoveStringPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
