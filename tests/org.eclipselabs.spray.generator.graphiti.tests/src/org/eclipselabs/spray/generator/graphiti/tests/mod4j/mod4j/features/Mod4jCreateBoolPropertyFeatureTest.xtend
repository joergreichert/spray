...
class Mod4jCreateBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBoolPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateBoolPropertyFeature extends Mod4jCreateBoolPropertyFeatureBase {
            public Mod4jCreateBoolPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
