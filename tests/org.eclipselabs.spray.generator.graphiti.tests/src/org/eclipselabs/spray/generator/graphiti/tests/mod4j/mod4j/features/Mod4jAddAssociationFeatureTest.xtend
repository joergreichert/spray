...
class Mod4jAddAssociationFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddAssociationFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddAssociationFeature extends Mod4jAddAssociationFeatureBase {
            public Mod4jAddAssociationFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
