...
class Mod4jLayoutStringFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutStringFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutStringFeature extends Mod4jLayoutStringFeatureBase {
            public Mod4jLayoutStringFeature(final IFeatureProvider fp) {
                super(fp);
            }
