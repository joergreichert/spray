...
class Mod4jAddBusinessClassFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBusinessClassFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jAddBusinessClassFeatureBase extends AbstractAddFeature {
            protected final static String typeOrAliasName = "BusinessClass";
            protected Diagram targetDiagram = null;
        
            public Mod4jAddBusinessClassFeatureBase(final IFeatureProvider fp) {
                super(fp);
