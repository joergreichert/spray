...
class Mod4jCreateBBBFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBBBFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateBBBFeature extends Mod4jCreateBBBFeatureBase {
            public Mod4jCreateBBBFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
