...
class Mod4jCreateBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBusinessRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateBusinessRuleFeature extends Mod4jCreateBusinessRuleFeatureBase {
            public Mod4jCreateBusinessRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
