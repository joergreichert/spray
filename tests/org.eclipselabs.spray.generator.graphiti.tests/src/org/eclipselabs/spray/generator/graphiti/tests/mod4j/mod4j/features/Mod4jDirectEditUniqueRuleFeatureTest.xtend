...
class Mod4jDirectEditUniqueRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditUniqueRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditUniqueRuleFeature extends Mod4jDirectEditUniqueRuleFeatureBase {
            public Mod4jDirectEditUniqueRuleFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
