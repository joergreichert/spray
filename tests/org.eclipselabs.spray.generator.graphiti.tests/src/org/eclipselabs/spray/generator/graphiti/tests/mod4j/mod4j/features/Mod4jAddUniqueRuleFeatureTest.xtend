...
class Mod4jAddUniqueRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddUniqueRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddUniqueRuleFeature extends Mod4jAddUniqueRuleFeatureBase {
            public Mod4jAddUniqueRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
