...
class Mod4jAddAutopackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddAutopackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddAutopackageFeature extends Mod4jAddAutopackageFeatureBase {
            public Mod4jAddAutopackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
