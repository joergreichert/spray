...
class Mod4jCreateSimpleClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateSimpleClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateSimpleClassFeature extends Mod4jCreateSimpleClassFeatureBase {
            public Mod4jCreateSimpleClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
