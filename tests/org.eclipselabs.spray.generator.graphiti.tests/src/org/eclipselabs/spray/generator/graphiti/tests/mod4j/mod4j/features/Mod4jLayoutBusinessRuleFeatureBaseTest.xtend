...
class Mod4jLayoutBusinessRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBusinessRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jLayoutBusinessRuleFeatureBase extends AbstractLayoutFeature {
        	
        	SprayLayoutManager layoutManager; 
        
            public Mod4jLayoutBusinessRuleFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canLayout(final ILayoutContext context) {
               ...
               return (businessObjects.size() == 1) && (businessObjects.get(0) instanceof BusinessRule);
            }
            /**
             * {@inheritDoc}
             */
