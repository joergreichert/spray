...
class Mod4jResizeStringPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeStringPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jResizeStringPropertyFeature extends Mod4jResizeStringPropertyFeatureBase {
            public Mod4jResizeStringPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
