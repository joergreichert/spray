...
class Mod4jLayoutBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBusinessRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutBusinessRuleFeature extends Mod4jLayoutBusinessRuleFeatureBase {
            public Mod4jLayoutBusinessRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
