...
class BoolPropertyHasDefaultSectionBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/BoolPropertyHasDefaultSectionBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class BoolPropertyHasDefaultSectionBase extends GFPropertySection implements ITabbedPropertyConstants {
