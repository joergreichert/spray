...
class Mod4jUpdateBusinessRuleFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBusinessRuleFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateBusinessRuleFeature extends Mod4jUpdateBusinessRuleFeatureBase {
            public Mod4jUpdateBusinessRuleFeature(final IFeatureProvider fp) {
                super(fp);
            }
