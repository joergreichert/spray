...
class Mod4jLayoutAutopackageFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutAutopackageFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jLayoutAutopackageFeatureBase extends AbstractLayoutFeature {
        	
        	SprayLayoutManager layoutManager; 
        
            public Mod4jLayoutAutopackageFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canLayout(final ILayoutContext context) {
               ...
               return (businessObjects.size() == 1) && (businessObjects.get(0) instanceof samplepackage.Package);
            }
            /**
             * {@inheritDoc}
             */
