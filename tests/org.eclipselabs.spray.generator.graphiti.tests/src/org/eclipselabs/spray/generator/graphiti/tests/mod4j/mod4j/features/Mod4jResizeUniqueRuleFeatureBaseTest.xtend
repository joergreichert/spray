...
class Mod4jResizeUniqueRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jResizeUniqueRuleFeatureBase.java"
    ...
    def private expectedContent() '''
         	...
         	public abstract class Mod4jResizeUniqueRuleFeatureBase extends DefaultResizeShapeFeature {
         	
         		SprayLayoutManager layoutManager; 
         	
         		public Mod4jResizeUniqueRuleFeatureBase(final IFeatureProvider fp) {
         			super(fp);
