...
class Mod4jLayoutPackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutPackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutPackageFeature extends Mod4jLayoutPackageFeatureBase {
            public Mod4jLayoutPackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
