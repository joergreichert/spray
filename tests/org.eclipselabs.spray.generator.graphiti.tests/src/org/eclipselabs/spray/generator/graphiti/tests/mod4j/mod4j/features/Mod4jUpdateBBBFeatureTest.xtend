...
class Mod4jUpdateBBBFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBBBFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateBBBFeature extends Mod4jUpdateBBBFeatureBase {
            public Mod4jUpdateBBBFeature(final IFeatureProvider fp) {
                super(fp);
            }
