...
class Mod4jAddBBBFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBBBFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddBBBFeature extends Mod4jAddBBBFeatureBase {
            public Mod4jAddBBBFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
