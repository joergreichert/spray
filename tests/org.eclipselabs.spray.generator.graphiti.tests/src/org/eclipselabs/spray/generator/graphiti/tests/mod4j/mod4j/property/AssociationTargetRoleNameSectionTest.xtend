...
class AssociationTargetRoleNameSectionTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/AssociationTargetRoleNameSection.java"
    ...
    def private expectedContent() '''
        ...
        public class AssociationTargetRoleNameSection extends AssociationTargetRoleNameSectionBase {
