...
class Mod4jAddReferenceBusinessClassSuperclassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddReferenceBusinessClassSuperclassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddReferenceBusinessClassSuperclassFeature extends Mod4jAddReferenceBusinessClassSuperclassFeatureBase {
            public Mod4jAddReferenceBusinessClassSuperclassFeature(final IFeatureProvider fp) {
                super(fp);
            }
            //  /**
            //   * {@inheritDoc}
