...
class Mod4jMoveAutopackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveAutopackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveAutopackageFeature extends Mod4jMoveAutopackageFeatureBase {
            public Mod4jMoveAutopackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
