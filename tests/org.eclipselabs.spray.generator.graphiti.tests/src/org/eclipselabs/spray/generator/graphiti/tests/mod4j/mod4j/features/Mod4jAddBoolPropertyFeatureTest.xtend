...
class Mod4jAddBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBoolPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddBoolPropertyFeature extends Mod4jAddBoolPropertyFeatureBase {
            public Mod4jAddBoolPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
