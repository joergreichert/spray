...
class Mod4jMoveStringFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveStringFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jMoveStringFeatureBase extends DefaultMoveShapeFeature {
        
            SprayLayoutManager layoutManager; 
        
            public Mod4jMoveStringFeatureBase(final IFeatureProvider fp) {
                super(fp);
