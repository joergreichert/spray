...
class Mod4jDirectEditBoolPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditBoolPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditBoolPropertyFeature extends Mod4jDirectEditBoolPropertyFeatureBase {
            public Mod4jDirectEditBoolPropertyFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
