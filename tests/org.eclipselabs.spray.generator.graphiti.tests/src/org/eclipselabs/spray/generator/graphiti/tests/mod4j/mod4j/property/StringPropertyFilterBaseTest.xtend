...
class StringPropertyFilterBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/property/StringPropertyFilterBase.java"
    ...
    def private expectedContent() '''
        ...
        public class StringPropertyFilterBase extends AbstractPropertySectionFilter {
