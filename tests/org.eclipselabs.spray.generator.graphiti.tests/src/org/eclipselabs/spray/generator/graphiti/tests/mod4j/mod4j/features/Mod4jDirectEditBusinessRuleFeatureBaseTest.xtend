...
class Mod4jDirectEditBusinessRuleFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditBusinessRuleFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jDirectEditBusinessRuleFeatureBase extends AbstractDirectEditingFeature {
        
            protected IPeService peService = Graphiti.getPeService();
        
            public Mod4jDirectEditBusinessRuleFeatureBase(IFeatureProvider fp) {
                super(fp);
            }
