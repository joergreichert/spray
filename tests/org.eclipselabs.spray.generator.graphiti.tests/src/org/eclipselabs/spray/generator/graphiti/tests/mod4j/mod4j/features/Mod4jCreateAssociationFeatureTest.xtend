...
class Mod4jCreateAssociationFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateAssociationFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateAssociationFeature extends Mod4jCreateAssociationFeatureBase {
            public Mod4jCreateAssociationFeature(final IFeatureProvider fp) {
                super(fp);
            }
