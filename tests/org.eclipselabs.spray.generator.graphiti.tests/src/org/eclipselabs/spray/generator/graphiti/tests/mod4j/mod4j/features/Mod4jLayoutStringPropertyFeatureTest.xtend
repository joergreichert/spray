...
class Mod4jLayoutStringPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutStringPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutStringPropertyFeature extends Mod4jLayoutStringPropertyFeatureBase {
            public Mod4jLayoutStringPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
