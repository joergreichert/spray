...
class Mod4jLayoutBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBusinessClassNameOnlyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jLayoutBusinessClassNameOnlyFeatureBase extends AbstractLayoutFeature {
        	
        	SprayLayoutManager layoutManager; 
        
            public Mod4jLayoutBusinessClassNameOnlyFeatureBase(final IFeatureProvider fp) {
                super(fp);
