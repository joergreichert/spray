...
class Mod4jMoveBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveBusinessClassNameOnlyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jMoveBusinessClassNameOnlyFeatureBase extends DefaultMoveShapeFeature {
        
            SprayLayoutManager layoutManager; 
        
            public Mod4jMoveBusinessClassNameOnlyFeatureBase(final IFeatureProvider fp) {
                super(fp);
                ...
                if (target instanceof samplepackage.Package) {
                    if (SprayLayoutService.isCompartment(targetContainer) ) {
                        ...
                        if ((id != null) && (id.equals("classes"))) {
                            ...
                            ((samplepackage.Package) target).getClasses().add((BusinessClass) source);
