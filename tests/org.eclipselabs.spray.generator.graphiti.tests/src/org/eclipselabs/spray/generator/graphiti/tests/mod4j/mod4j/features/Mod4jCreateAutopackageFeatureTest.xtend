...
class Mod4jCreateAutopackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateAutopackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jCreateAutopackageFeature extends Mod4jCreateAutopackageFeatureBase {
            public Mod4jCreateAutopackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
