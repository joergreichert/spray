...
class Mod4jUpdateStringPropertyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateStringPropertyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateStringPropertyFeature extends Mod4jUpdateStringPropertyFeatureBase {
            public Mod4jUpdateStringPropertyFeature(final IFeatureProvider fp) {
                super(fp);
            }
