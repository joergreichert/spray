...
class Mod4jUpdateBusinessClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBusinessClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jUpdateBusinessClassFeature extends Mod4jUpdateBusinessClassFeatureBase {
            public Mod4jUpdateBusinessClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
