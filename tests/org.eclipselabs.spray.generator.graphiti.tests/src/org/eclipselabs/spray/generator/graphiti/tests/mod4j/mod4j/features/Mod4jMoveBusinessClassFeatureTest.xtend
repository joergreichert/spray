...
class Mod4jMoveBusinessClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveBusinessClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveBusinessClassFeature extends Mod4jMoveBusinessClassFeatureBase {
            public Mod4jMoveBusinessClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
