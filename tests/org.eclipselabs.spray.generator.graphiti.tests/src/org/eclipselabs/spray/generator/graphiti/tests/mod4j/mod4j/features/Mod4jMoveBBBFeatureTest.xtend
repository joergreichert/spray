...
class Mod4jMoveBBBFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveBBBFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveBBBFeature extends Mod4jMoveBBBFeatureBase {
            public Mod4jMoveBBBFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
