...
class Mod4jUpdateBusinessClassFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBusinessClassFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jUpdateBusinessClassFeatureBase extends AbstractUpdateFeature {
            public Mod4jUpdateBusinessClassFeatureBase(final IFeatureProvider fp) {
                super(fp);
