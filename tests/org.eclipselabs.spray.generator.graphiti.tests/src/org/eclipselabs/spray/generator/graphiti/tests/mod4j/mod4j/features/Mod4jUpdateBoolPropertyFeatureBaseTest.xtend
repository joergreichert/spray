...
class Mod4jUpdateBoolPropertyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jUpdateBoolPropertyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jUpdateBoolPropertyFeatureBase extends AbstractUpdateFeature {
            public Mod4jUpdateBoolPropertyFeatureBase(final IFeatureProvider fp) {
                super(fp);
            ...
            public boolean canUpdate(final IUpdateContext context) {
                // return true, if linked business object is a BoolProperty
                final PictogramElement pictogramElement = context.getPictogramElement();
                final Object bo = getBusinessObjectForPictogramElement(pictogramElement);
                return (bo instanceof BoolProperty) && (!(pictogramElement instanceof Diagram));
            }
            ...
            public IReason updateNeeded(final IUpdateContext context) {
                final PictogramElement pictogramElement = context.getPictogramElement();
                final Object bo = getBusinessObjectForPictogramElement(pictogramElement);
                if (!(bo instanceof BoolProperty)) {
                    return Reason.createFalseReason();
                }
                if (pictogramElement instanceof Shape) {
                    Shape shape = (Shape) pictogramElement;
                    BoolProperty eClass = (BoolProperty) bo;
            ...
            protected boolean checkUpdateNeededRecursively(Shape shape, final BoolProperty eClass) {
