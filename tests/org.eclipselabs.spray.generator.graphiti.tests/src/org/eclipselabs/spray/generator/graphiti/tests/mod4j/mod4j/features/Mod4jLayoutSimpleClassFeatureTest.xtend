...
class Mod4jLayoutSimpleClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutSimpleClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutSimpleClassFeature extends Mod4jLayoutSimpleClassFeatureBase {
            public Mod4jLayoutSimpleClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
