...
class Mod4jDirectEditAssociationFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jDirectEditAssociationFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jDirectEditAssociationFeature extends Mod4jDirectEditAssociationFeatureBase {
            public Mod4jDirectEditAssociationFeature(IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
