...
class Mod4jLayoutBusinessClassNameOnlyFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBusinessClassNameOnlyFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutBusinessClassNameOnlyFeature extends Mod4jLayoutBusinessClassNameOnlyFeatureBase {
            public Mod4jLayoutBusinessClassNameOnlyFeature(final IFeatureProvider fp) {
                super(fp);
            }
