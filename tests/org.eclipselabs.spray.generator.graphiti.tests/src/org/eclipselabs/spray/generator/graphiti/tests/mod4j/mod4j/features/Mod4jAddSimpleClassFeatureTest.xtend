...
class Mod4jAddSimpleClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddSimpleClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddSimpleClassFeature extends Mod4jAddSimpleClassFeatureBase {
            public Mod4jAddSimpleClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
