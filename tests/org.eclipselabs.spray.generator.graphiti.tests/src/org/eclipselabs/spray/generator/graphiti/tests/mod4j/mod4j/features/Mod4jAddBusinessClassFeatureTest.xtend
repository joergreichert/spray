...
class Mod4jAddBusinessClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jAddBusinessClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jAddBusinessClassFeature extends Mod4jAddBusinessClassFeatureBase {
            public Mod4jAddBusinessClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
