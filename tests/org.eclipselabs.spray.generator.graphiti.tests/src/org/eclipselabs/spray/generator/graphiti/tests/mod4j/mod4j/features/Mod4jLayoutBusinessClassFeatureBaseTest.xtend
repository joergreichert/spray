...
class Mod4jLayoutBusinessClassFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutBusinessClassFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jLayoutBusinessClassFeatureBase extends AbstractLayoutFeature {
        	
        	SprayLayoutManager layoutManager; 
        
            public Mod4jLayoutBusinessClassFeatureBase(final IFeatureProvider fp) {
                super(fp);
