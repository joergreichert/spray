...
class Mod4jCreateBusinessClassNameOnlyFeatureBaseTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jCreateBusinessClassNameOnlyFeatureBase.java"
    ...
    def private expectedContent() '''
        ...
        public abstract class Mod4jCreateBusinessClassNameOnlyFeatureBase extends AbstractCreateFeature {
            ...
            public Mod4jCreateBusinessClassNameOnlyFeatureBase (final IFeatureProvider fp) {
                // set name and description of the creation feature
                super(fp, "BusinessClassNameOnly", "Create new BusinessClassNameOnly");
            ...
            public Object[] create(final ICreateContext context) {
                newClass = createBusinessClassNameOnly(context);
            ...
            //       org.eclipse.emf.ecore.impl.EReferenceImpl@edbf075 (name: types) (ordered: true, unique: true, lowerBound: 0, upperBound: -1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (containment: true, resolveProxies: false) 
                     ...
                     */
                    protected BusinessClass createBusinessClassNameOnly(final ICreateContext context) {
                        // create BusinessClass instance
                        final BusinessClass newClass = BusinessDomainDslFactory.eINSTANCE.createBusinessClass();
                        // ask user for BusinessClassNameOnly name
            ...
            protected PictogramElement addGraphicalRepresentation(final IAreaContext context, final Object newObject) {
                ...
                ctx.putProperty(PROPERTY_ALIAS, "BusinessClassNameOnly");
