...
class Mod4jLayoutAutopackageFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jLayoutAutopackageFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jLayoutAutopackageFeature extends Mod4jLayoutAutopackageFeatureBase {
            public Mod4jLayoutAutopackageFeature(final IFeatureProvider fp) {
                super(fp);
            }
