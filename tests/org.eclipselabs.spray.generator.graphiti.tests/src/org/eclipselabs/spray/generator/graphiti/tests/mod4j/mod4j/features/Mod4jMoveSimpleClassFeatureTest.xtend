...
class Mod4jMoveSimpleClassFeatureTest extends AbstractSprayGeneratorTest {

    @Test
    def void test() {
       val fsa = triggerGenerator("mod4j/mod4j-busmod.spray")
       val keyClass = "DEFAULT_OUTPUTorg/eclipselabs/spray/examples/mod4j/features/Mod4jMoveSimpleClassFeature.java"
    ...
    def private expectedContent() '''
        ...
        public class Mod4jMoveSimpleClassFeature extends Mod4jMoveSimpleClassFeatureBase {
            public Mod4jMoveSimpleClassFeature(final IFeatureProvider fp) {
                super(fp);
            }
        }
    '''
