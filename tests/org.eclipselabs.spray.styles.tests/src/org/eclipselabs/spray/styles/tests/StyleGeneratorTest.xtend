...
class StyleGeneratorTest {
    ...
    def testGenerateStyleModelFull() {
        ...
        assertEquals("Expected file content generated", styleModelFullExpectedContent.toString,
            entries.head.value.toString)
    }
    ...
    def testGenerateStyleModelMin() {
        ...
        assertEquals("Expected file content generated", styleModelMinExpectedContent.toString,
            entries.head.value.toString)
    }
    ...
    def testGenerateStyleModelOther() {
        ...
        assertEquals("Expected file content generated", styleModelOtherExpectedContent.toString,
            entries.head.value.toString)
    }
    ...
    def testGenerateStyleModelInheritence() {
        ...
        val JavaGenFile java = genFileProvider.get()
        java.access = fsa
        styleModelInheritence.parse.styleContainerElement.filter(typeof(Style)).forEach(
            style|java.doGenerateStyle(style))
        val entries = fsa.files.entrySet
        ...
        assertNotNull( /*"In expected file output generated for parent style", "DEFAULT_OUTPUTstyles/MyParentStyle.java",*/
            parentEntry)
        val childEntry = entries.findFirst(e|e.key.equals("DEFAULT_OUTPUTstyles/MyChildStyleBase.java"))
        assertNotNull( /*"In expected file output generated for child style", "DEFAULT_OUTPUTstyles/MyChildStyle.java",*/
            childEntry)
        assertEquals("Expected file content generated for child style",
            styleModelInheritenceExpectedChildContent.toString, childEntry.value.toString)
    }
    ...
    def testGenerateGradientModel() {
        ...
        assertNotNull( /*"In expected file output generated for child style", "DEFAULT_OUTPUTgradients/MyGradient.java",*/
            gradientEntry)
        assertEquals("Expected file content generated for child style", gradientModelExpectedGradientContent.toString,
            gradientEntry.value.toString)
        ...
        assertEquals("Expected file content generated for child style", gradientModelExpectedStyleContent.toString,
    ...
    def private gradientModelExpectedStyleContent() '''
        ...
        public class MyStyleBase extends org.eclipselabs.spray.runtime.graphiti.styles.DefaultSprayStyle {
            ...
            public AdaptedGradientColoredAreas getColorSchema() {
                ...
                agca.setDefinedStyleId("MyStyleBase_Color_Schema_ID");
                agca.setGradientType(IGradientType.HORIZONTAL);
                agca.getAdaptedGradientColoredAreas().add(IPredefinedRenderingStyle.STYLE_ADAPTATION_DEFAULT, new gradients.MyGradient().getGradientColoredAreas( ));
                return agca;
            }
        }
    '''
