...
public abstract class AbstractProposalTest extends AbstractContentAssistProcessorTest {
	...
	protected ISetup doGetSetup() {
		return new ISetup() {
			...
			public Injector createInjectorAndDoEMFRegistration() {
				return getInjectorProvider().getInjector();
			}
		};
	}
	...
	public abstract IInjectorProvider getInjectorProvider();
}
