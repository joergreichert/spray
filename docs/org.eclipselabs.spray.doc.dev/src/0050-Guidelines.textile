...
* The Code Generator must be executable standalone (Maven, Ant, Commandline) without an Eclipse installation
* The Code Generator should be extensible by the user without the need to change the original plugin sources
