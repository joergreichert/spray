...
* For this go to _Help > Install New Software > Add_ 
...
* _Window > Show View > Other... > Mylyn/Task_ Repositories
* Open context menu in Task Repositories view > _Add task repositories_...
* Google Code, Next
...
** enter your Google Account credentials (now use as password your Google Mail password, not the Google Code Password) > _Validate Settings_ > Finish
!images/mylyn_1.png!
* Add New Query
* use predefined query > _Open issues_
!images/mylyn_2.png!
* _Window > Show View > Other... > Mylyn/Task List_
