...
h4. Variant 1: Use update site directly

Use archived update site containing the features for the development IDE: _Help -> Install New Software_ -> _Add_
* Name: Spray Development Environment
* Location: https://spray.ci.cloudbees.com/job/spray-ci-build/lastSuccessfulBuild/artifact/devtools/org.eclipselabs.spray.dev.updatesite/target/org.eclipselabs.spray.dev.updatesite-0.4.0-SNAPSHOT-updatesite.zip

h4. Variant 2: Import update sites locally
...
** if you had already cloned Spray
*** Add
