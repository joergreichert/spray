...
The build executes UI tests developed with SWTBot ( "@http://www.eclipse.org/swtbot/@":http://www.eclipse.org/swtbot/ by default. If you want to skip executing these tests, add the @skip-ui-tests@ property:
