...
bc. public class BlackAndWhiteStyle extends DefaultSprayStyle implements ISprayStyle
...
bc. description = "A style for white background and black foreground."
