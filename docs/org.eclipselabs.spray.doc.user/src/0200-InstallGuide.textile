...
* Install "Eclipse Juno IDE (= Eclipse 4.2.1)":http://www.eclipse.org/downloads/packages. Eclipse Classic or Eclipse Modeling Tools are appropriate Eclipse packages. (If you want to use the latest Spray release, 0.4.0, in favor of the latest stable CI build. please download and install Eclipse Indigo (= 3.7.2) instead). 
